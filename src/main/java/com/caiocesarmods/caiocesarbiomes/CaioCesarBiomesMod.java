    ...
    private void setup(final FMLCommonSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            AxeItem.BLOCK_STRIPPING_MAP = new ImmutableMap.Builder<Block, Block>().putAll(AxeItem.BLOCK_STRIPPING_MAP)
                    ...
                    .put(ModWood.PRIVET_LOG.get(), ModWood.STRIPPED_LIGHTWOOD_LOG.get())
                    .put(ModWood.PRIVET_WOOD.get(), ModWood.STRIPPED_LIGHTWOOD_WOOD.get())
                    ...
                    .put(ModWood.TEA_LOG.get(), ModWood.STRIPPED_LIGHTWOOD_LOG.get())
                    .put(ModWood.TEA_WOOD.get(), ModWood.STRIPPED_LIGHTWOOD_WOOD.get())
