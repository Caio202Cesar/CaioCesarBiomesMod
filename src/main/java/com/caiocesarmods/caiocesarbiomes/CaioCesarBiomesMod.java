    ...
    private void setup(final FMLCommonSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            AxeItem.BLOCK_STRIPPING_MAP = new ImmutableMap.Builder<Block, Block>().putAll(AxeItem.BLOCK_STRIPPING_MAP)
                    ...
                    .put(TreeBlocks.CINNAMON_LOG.get(),  TreeBlocks.STRIPPED_LAUREL_LOG.get())
                    .put(TreeBlocks.CINNAMON_WOOD.get(), TreeBlocks.STRIPPED_LAUREL_WOOD.get())
                    ...
                    .put(TreeBlocks.EUCALYPTUS_LOG.get(), TreeBlocks.STRIPPED_MYRTACEAE_LOG.get())
                    .put(TreeBlocks.EUCALYPTUS_WOOD.get(), TreeBlocks.STRIPPED_MYRTACEAE_WOOD.get())
                    .put(TreeBlocks.RAINBOW_EUCALYPTUS_LOG.get(), TreeBlocks.STRIPPED_MYRTACEAE_LOG.get())
                    .put(TreeBlocks.RAINBOW_EUCALYPTUS_WOOD.get(), TreeBlocks.STRIPPED_MYRTACEAE_WOOD.get())
                    ...
                    .put(TreeBlocks.BAOBAB_LOG.get(), TreeBlocks.STRIPPED_BAOBAB_LOG.get())
                    .put(TreeBlocks.BAOBAB_WOOD.get(), TreeBlocks.STRIPPED_BAOBAB_WOOD.get())
                    .put(TreeBlocks.OBTUSA_OAK_LOG.get(), TreeBlocks.STRIPPED_OBTUSA_OAK_LOG.get())
                    .put(TreeBlocks.OBTUSA_OAK_WOOD.get(), TreeBlocks.STRIPPED_OBTUSA_OAK_WOOD.get())
                    .put(TreeBlocks.CHAMPAK_LOG.get(), TreeBlocks.STRIPPED_CHAMPAK_LOG.get())
                    .put(TreeBlocks.CHAMPAK_WOOD.get(), TreeBlocks.STRIPPED_CHAMPAK_WOOD.get())
                    .put(TreeBlocks.PAPERBARK_LOG.get(), TreeBlocks.STRIPPED_MYRTACEAE_LOG.get())
                    .put(TreeBlocks.PAPERBARK_WOOD.get(), TreeBlocks.STRIPPED_MYRTACEAE_WOOD.get())
                    ...
                    .put(TreeBlocks.RING_CUPPED_OAK_LOG.get(), Blocks.STRIPPED_OAK_LOG)
                    ...
                    .put(TreeBlocks.SAND_LAUREL_OAK_LOG.get(), Blocks.STRIPPED_OAK_LOG)
                    ...
                    .put(TreeBlocks.MYRTACEAE_LOG.get(), TreeBlocks.STRIPPED_MYRTACEAE_LOG.get())
                    .put(TreeBlocks.MYRTACEAE_WOOD.get(), TreeBlocks.STRIPPED_MYRTACEAE_WOOD.get())
                    ...
                    .put(TreeBlocks.MESQUITE_LOG.get(), TreeBlocks.STRIPPED_MESQUITE_LOG.get())
                    .put(TreeBlocks.MESQUITE_WOOD.get(), TreeBlocks.STRIPPED_MESQUITE_WOOD.get())
                    .put(TreeBlocks.BAYBERRY_LOG.get(), TreeBlocks.STRIPPED_BAYBERRY_LOG.get())
                    .put(TreeBlocks.BAYBERRY_WOOD.get(), TreeBlocks.STRIPPED_BAYBERRY_WOOD.get())
                    ...
                    .put(TreeBlocks.COTTONWOOD_LOG.get(), TreeBlocks.STRIPPED_COTTONWOOD_LOG.get())
                    .put(TreeBlocks.COTTONWOOD_WOOD.get(), TreeBlocks.STRIPPED_COTTONWOOD_WOOD.get())
                    .put(TreeBlocks.TEA_LOG.get(), TreeBlocks.STRIPPED_TEA_LOG.get())
                    .put(TreeBlocks.TEA_WOOD.get(), TreeBlocks.STRIPPED_TEA_WOOD.get())
                    ...
                    .put(TreeBlocks.CRAPE_MYRTLE_LOG.get(), TreeBlocks.STRIPPED_CRAPE_MYRTLE_LOG.get())
                    .put(TreeBlocks.CRAPE_MYRTLE_WOOD.get(), TreeBlocks.STRIPPED_CRAPE_MYRTLE_WOOD.get())
                    .put(TreeBlocks.POMEGRANATE_LOG.get(), TreeBlocks.STRIPPED_CRAPE_MYRTLE_LOG.get())
                    .put(TreeBlocks.POMEGRANATE_WOOD.get(), TreeBlocks.STRIPPED_CRAPE_MYRTLE_WOOD.get())
