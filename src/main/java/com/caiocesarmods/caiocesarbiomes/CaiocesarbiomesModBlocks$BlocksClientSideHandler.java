...
public class CaiocesarbiomesModBlocks$BlocksClientSideHandler {
    ...
    public static void clientSetup(FMLClientSetupEvent event) {
        ...
        KiwiGoldVine.registerRenderLayer();
        ChileanBellflowerRed.registerRenderLayer();
        ...
        ResurrectionFernBlock.registerRenderLayer();
        ...
        CalafateBush.registerRenderLayer();
        ChileanGuavaBush.registerRenderLayer();
        ...
        BaobabFruitBlock.registerRenderLayer();
        BaobabFlowerBlock.registerRenderLayer();
        ...
        PinkIvorySapling.registerRenderLayer();
        YellowOleanderSapling.registerRenderLayer();
        ...
        CoihueSapling.registerRenderLayer();
        ...
        LaurelOakSapling.registerRenderLayer();
        CamphorSapling.registerRenderLayer();
        CinnamonSapling.registerRenderLayer();
        ...
        HoopPineSapling.registerRenderLayer();
