...
public class HardinessZones {
    ...
    static {
        ...
        SAPLING_ZONES.put(new ResourceLocation("minecraft", "spruce_sapling"), "min 2, max 7");
        ...
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "hazelnut_sapling"),
                "winter min 4, winter max 9");
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "holly_sapling"),
                "winter min 6, winter max 10; requires warm to cooler summers");
