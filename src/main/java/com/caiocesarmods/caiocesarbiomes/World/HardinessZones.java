...
public class HardinessZones {
    ...
    static {
        ...
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "chinese_red_pine_sapling"), "min 9, max 9");
        ...
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "cork_oak_sapling"), "min 4, max 6");
