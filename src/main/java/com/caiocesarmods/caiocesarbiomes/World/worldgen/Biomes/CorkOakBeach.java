...
public class CorkOakBeach {
    public static final DeferredRegister<Biome> BIOMES
            = DeferredRegister.create(ForgeRegistries.BIOMES, CaioCesarBiomesMod.MOD_ID);

    public static final RegistryObject<Biome> CORK_OAK_BEACH = BIOMES.register("cork_oak_beach",
            () -> makeMediterraneanCorkOakSavannaBeach(() -> ConfiguredSurfaceBuilders.DESERT, 0.0F, 0.025F));

    private static Biome makeMediterraneanCorkOakSavannaBeach(final Supplier<ConfiguredSurfaceBuilder<?>> surfaceBuilder, float depth, float scale) {
