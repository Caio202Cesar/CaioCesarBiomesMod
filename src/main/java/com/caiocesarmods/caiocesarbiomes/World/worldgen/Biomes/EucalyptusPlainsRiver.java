...
public class EucalyptusPlainsRiver {
    public static final DeferredRegister<Biome> BIOMES
            = DeferredRegister.create(ForgeRegistries.BIOMES, CaioCesarBiomesMod.MOD_ID);

    private static ConfiguredSurfaceBuilder<?> DefaultSurfaceBuilder;
    public static final RegistryObject<Biome> EUCALYPTUS_PLAINS_RIVER = BIOMES.register("eucalyptus_plains_river",
            () -> makeEucalyptusPlainsRiver(() -> ConfiguredSurfaceBuilders.GRASS, -0.5F, 0.0f));


    private static Biome makeEucalyptusPlainsRiver(final Supplier<ConfiguredSurfaceBuilder<?>> surfaceBuilder, float depth, float scale) {
