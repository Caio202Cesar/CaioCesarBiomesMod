...
public class LushSouthernTundraBiome {
    ...
    private static Biome makeLushSouthernTundraBiome(final Supplier<ConfiguredSurfaceBuilder<?>> surfaceBuilder, float depth, float scale) {
        ...
        biomegenerationsettings$builder.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, TreeFeatures.LUSH_SOUTHERN_TUNDRA_VEGETATION);
