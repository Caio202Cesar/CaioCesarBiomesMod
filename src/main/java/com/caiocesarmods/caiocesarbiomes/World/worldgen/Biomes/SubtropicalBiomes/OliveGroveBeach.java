...
public class OliveGroveBeach {
    public static final DeferredRegister<Biome> BIOMES
            = DeferredRegister.create(ForgeRegistries.BIOMES, CaioCesarBiomesMod.MOD_ID);

    public static final RegistryObject<Biome> OLIVE_GROVE_BEACH = BIOMES.register("olive_grove_beach",
            () -> makeOliveGroveBeach(() -> ConfiguredSurfaceBuilders.DESERT, 0.0F, 0.025F));

    private static Biome makeOliveGroveBeach(final Supplier<ConfiguredSurfaceBuilder<?>> surfaceBuilder, float depth, float scale) {
