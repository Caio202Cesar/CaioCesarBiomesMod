...
public class SubtropicalDesertRiver {
    ...
    private static Biome makeSahelRiver(final Supplier<ConfiguredSurfaceBuilder<?>> surfaceBuilder, float depth, float scale) {
        ...
        biomegenerationsettings$builder.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, ModFeatures.TREES_SAVANNA_NO_OAK);
