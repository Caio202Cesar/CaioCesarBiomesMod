...
public class JungleEdgeRiver {
    public static final DeferredRegister<Biome> BIOMES
            = DeferredRegister.create(ForgeRegistries.BIOMES, CaioCesarBiomesMod.MOD_ID);

    private static ConfiguredSurfaceBuilder<?> DefaultSurfaceBuilder;
    public static final RegistryObject<Biome> JUNGLE_EDGE_RIVER = BIOMES.register("jungle_edge_river",
            () -> makeJungleEdgeRiver(() -> ConfiguredSurfaceBuilders.SWAMP, -0.5F, 0.0f));

    //Add tropical river vegetation, like white ginger lily
    private static Biome makeJungleEdgeRiver(final Supplier<ConfiguredSurfaceBuilder<?>> surfaceBuilder, float depth, float scale) {
