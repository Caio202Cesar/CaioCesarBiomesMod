package com.caiocesarmods.caiocesarbiomes.World.worldgen.Biomes.TundraBiomes;
...
public class TussockTundraBeach {
    public static final DeferredRegister<Biome> BIOMES
            = DeferredRegister.create(ForgeRegistries.BIOMES, CaioCesarBiomesMod.MOD_ID);

    private static ConfiguredSurfaceBuilder<?> DefaultSurfaceBuilder;
    public static final RegistryObject<Biome> TUSSOCK_TUNDRA_BEACH = BIOMES.register("tussock_tundra_beach",
            () -> makeTussockTundraBeach(() -> ConfiguredSurfaceBuilders.DESERT, 0.0F, 0.025F));

    //Add elephant seals
    private static Biome makeTussockTundraBeach(final Supplier<ConfiguredSurfaceBuilder<?>> surfaceBuilder, float depth, float scale) {
