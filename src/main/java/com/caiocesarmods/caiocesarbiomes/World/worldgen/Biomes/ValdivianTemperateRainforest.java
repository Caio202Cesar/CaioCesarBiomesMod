...
public class ValdivianTemperateRainforest {
    public static final DeferredRegister<Biome> BIOMES
            = DeferredRegister.create(ForgeRegistries.BIOMES, CaioCesarBiomesMod.MOD_ID);

    private static ConfiguredSurfaceBuilder<?> DefaultSurfaceBuilder;
    public static final RegistryObject<Biome> VALDIVIAN_TEMPERATE_RAINFOREST = BIOMES.register("valdivian_temperate_rainforest",
            () -> makeValdivianTemperateRainforest(() -> ConfiguredSurfaceBuilders.GRASS, 0.1F, 0.2F));


    private static Biome makeValdivianTemperateRainforest(final Supplier<ConfiguredSurfaceBuilder<?>> surfaceBuilder, float depth, float scale) {
