package com.caiocesarmods.caiocesarbiomes.World.worldgen.HardinessZone;
...
public class HardinessZones {
    ...
    static {
        ...
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "breadfruit_sapling"), "HZ(min) 11, HZ(max) 12 (1.2F)");
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "buddha_hand_sapling"), "HZ(min) 10, HZ(max) 12;" +
                "⚠ can be grown in colder biomes if under a 5x5 glass roof");
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "bunya_pine_sapling"), "HZ(min) 9, HZ(max) 12 (1.2F)");
        ...
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "indian_coral_sapling"), "HZ(min) 10, HZ(max) 12");
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "indian_laurel_sapling"), "HZ(min) 9, HZ(max) 12");
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "italian_cypress_sapling"), "HZ(min) 7, HZ(max) 11");
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "jackalberry_sapling"), "HZ(min) 9, HZ(max) 12");
        ...
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "lemon_sapling"), "HZ(min) 9, HZ(max) 12;" +
        ...
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "pecan_sapling"), "HZ(min) 5, HZ(max) 10; " +
                "⚠ requires downfall 0.89F or lower; ⚠ requires hot summers for fruit and grow");
        ...
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "oleander_pink_sapling"), "HZ(min) 8, HZ(max) 13 (2F); " +
                "⚠ can be grown in colder biomes if under a 5x5 glass roof");
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "plumeria_pink_sapling"), "HZ(min) 10, HZ(max) 12; " +
                "⚠ can be grown in colder biomes if under a 7x7 glass roof");
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "pinyon_sapling"), "HZ(min) 4, HZ(max) 8;" +
        ...
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "ponderosa_pine_sapling"), "HZ(min) 3, HZ(max) 8; " +
                "⚠ max downfall tolerated: 0.55F");
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "crape_myrtle_purple_sapling"), "HZ(min) 7, HZ(max) 12;");
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "crabapple_red_sapling"), "HZ(min) 4, HZ(max) 8");
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "crape_myrtle_red_sapling"), "HZ(min) 7, HZ(max) 12;");
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "red_kapok_sapling"), "HZ(min) 10, HZ(max) 12;");
        ...
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "oleander_red_sapling"), "HZ(min) 8, HZ(max) 13 (2F); " +
                "⚠ can be grown in colder biomes if under a 5x5 glass roof");
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "plumeria_red_sapling"), "HZ(min) 10, HZ(max) 12;" +
                "⚠ can be grown in colder biomes if under a 7x7 glass roof");
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "rowan_sapling"), "HZ(min) 2, HZ(max) 7;" +
                "⚠ requires warm to cooler summers");
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "royal_poinciana_sapling"), "HZ(min) 10, HZ(max) 12;");
        ...
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "socotra_cucumber_sapling"), "HZ(min) 9, HZ(max) 13 (2F);" +
                "⚠ requires dry biomes");
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "socotra_desert_rose_sapling"), "HZ(min) 10, HZ(max) 13 (2F);" +
        ...
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "sycamore_fig_sapling"), "HZ(min) 10, HZ(max) 13 (2F)");
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "tahiti_lime_sapling"), "HZ(min) 9, HZ(max) 12;" +
                "⚠ can be grown in colder biomes if under a 7x7 glass roof");
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "tamarind_sapling"), "HZ(min) 10, HZ(max) 12;");
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "teak_sapling"), "HZ(min) 11, HZ(max) 12;");
        ...
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "tropical_almond_sapling"), "HZ(min) 10, HZ(max) 12;" +
                "⚠ requires hot summers");
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "walnut_sapling"), "HZ(min) 5, HZ(max) 10");
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "weeping_fig_sapling"), "HZ(min) 10, HZ(max) 12;" +
        ...
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "plumeria_yellow_sapling"), "HZ(min) 10, HZ(max) 12;" +
                "⚠ can be grown in colder biomes if under a 7x7 glass roof");
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "yew_sapling"), "HZ(min) 5, HZ(max) 10;" +
                "⚠ Requires warm or cooler summers");
        ...
        SAPLING_ZONES.put(new ResourceLocation("caiocesarbiomes", "maritime_pine_sapling"), "HZ(min) 8, HZ(max) 10");
        ...
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "apricot_ipe_sapling"), "HZ(min) 9, HZ(max) 12");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "babassu_sapling"), "HZ(min) 10, HZ(max) 12");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "bacuri_sapling"), "HZ(min) 11, HZ(max) 12");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "balsa_sapling"), "HZ(min) 11, HZ(max) 12");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "black_jurema_sapling"), "HZ(min) 9, HZ(max) 13 (2F);" +
                "⚠ requires downfall of 0.6F or lower to grow");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "black_sucupira_sapling"), "HZ(min) 10, HZ(max) 13 (2F)");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "brazillian_pepper_sapling"), "HZ(min) 9, HZ(max) 13 (2F);" +
                "⚠ can be grown in colder biomes if under a 5x5 to 9x9 glass roof");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "brazillian_rosewood_sapling"), "HZ(min) 10, HZ(max) 12");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "brazillian_sassafras_sapling"), "HZ(min) 9, HZ(max) 12 (1.2F);");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "brazillian_tigerwood_sapling"), "HZ(min) 10, HZ(max) 13 (2F)");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "brazilnut_sapling"), "HZ(min) 12, HZ(max) 12 (1.2F);");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "brazilwood_sapling"), "HZ(min) 10, HZ(max) 12");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "buriti_sapling"), "HZ(min) 11, HZ(max) 12");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "cagaita_sapling"), "HZ(min) 9, HZ(max) 12");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "cambuci_sapling"), "HZ(min) 10, HZ(max) 11");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "camu_camu_sapling"), "HZ(min) 10, HZ(max) 12" +
                "⚠ can be grown in colder biomes if under a 5x5 glass roof");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "carnauba_sapling"), "HZ(min) 10, HZ(max) 13 (2F);");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "cashew_sapling"), "HZ(min) 11, HZ(max) 13 (2F);");
        ...
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "cecropia_sapling"), "HZ(min) 10, HZ(max) 12");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "cockspur_coral_sapling"), "HZ(min) 9, HZ(max) 11;" +
        "⚠ can be grown in colder biomes if under a 5x5 to 7x7 glass roof");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "cupuacu_sapling"), "HZ(min) 11, HZ(max) 12 (1.2F);" +
                "⚠ can be grown in colder biomes if under a 5x5 glass roof"); //Only small trees and bushes can be grown in greenhouses
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "feijoa_sapling"), "HZ(min) 8, HZ(max) 10;" +
                "⚠ fruiting requires warm summers");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "guapuruvu_sapling"), "HZ(min) 9, HZ(max) 12");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "guarana_sapling"), "HZ(min) 11, HZ(max) 12 (1.2F);" +
                "⚠ can be grown in colder biomes if under a 5x5 glass roof");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "humboldt_willow_sapling"), "HZ(min) 9, HZ(max) 12");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "imbuia_sapling"), "HZ(min) 9*, HZ(max) 10; " +
                        "⚠ can only be grown under other tree's canopies;" +
                        "⚠ literally dies in zone 9 winter if not under a canopy;" +
                        "⚠ cannot grow in dry biomes");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "jabuticaba_sapling"), "HZ(min) 9, HZ(max) 12");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "jelly_palm_sapling"), "HZ(min) 8, HZ(max) 12");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "jenipapo_sapling"), "HZ(min) 10, HZ(max) 12");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "jequitiba_sapling"), "HZ(min) 10, HZ(max) 12");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "jua_sapling"), "HZ(min) 11, HZ(max) 13 (2F)");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "jussara_sapling"), "HZ(min) 9, HZ(max) 12");
        ...
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "monkey_cajarana_sapling"), "HZ(min) 11, HZ(max) 13 (2F);" +
                        "⚠ can be grown in colder biomes if under a 5x5 glass roof");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "oiticica_sapling"), "HZ(min) 11, HZ(max) 13 (2F);");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "parana_pine_sapling"), "HZ(min) 8, HZ(max) 10");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "pequi_sapling"), "HZ(min) 11, HZ(max) 12");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "peruvian_pepper_sapling"), "HZ(min) 9, HZ(max) 13 (2F);" +
                "⚠ can be grown in colder biomes if under a 5x5 to 7x7 glass roof");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "pink_ipe_sapling"), "HZ(min) 9, HZ(max) 13 (2F);");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "pink_peroba_sapling"), "HZ(min) 10, HZ(max) 12");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "silk_floss_pink_sapling"), "HZ(min) 9, HZ(max) 13 (2F)");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "pitanga_sapling"), "HZ(min) 9, HZ(max) 12;" +
                "⚠ can be grown in colder biomes if under a 5x5 glass roof");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "purpleheart_sapling"), "HZ(min) 10, HZ(max) 12;");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "purple_ipe_sapling"), "HZ(min) 9, HZ(max) 13 (2F);");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "queen_palm_sapling"), "HZ(min) 9, HZ(max) 12;");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "rio_grande_cherry_sapling"), "HZ(min) 9, HZ(max) 11");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "sandbox_tree_sapling"), "HZ(min) 10, HZ(max) 12");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "sapucaia_sapling"), "HZ(min) 10, HZ(max) 12");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "sharinga_sapling"), "HZ(min) 11, HZ(max) 12 (1.2F)");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "cecropia_silver_sapling"), "HZ(min) 10, HZ(max) 12");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "silver_pepper_sapling"), "HZ(min) 9, HZ(max) 11;" +
                "⚠ can be grown in colder biomes if under a 5x5 glass roof");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "sombreiro_sapling"), "HZ(min) 9, HZ(max) 12");
        ...
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "wolf_apple_sapling"), "HZ(min) 9, HZ(max) 12");
        ...
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "passion_fruit_fruiting_vine"), "HZ(min) 10, HZ(max) 12;" +
                "⚠ can be grown in colder biomes if under glass");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "passion_fruit_purple_vine"), "HZ(min) 9, HZ(max) 11;" +
                "⚠ can be grown in colder biomes if under glass");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "passion_fruit_purple_flowering_vine"), "HZ(min) 9, HZ(max) 11;" +
                "⚠ can be grown in colder biomes if under glass");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "passion_fruit_purple_fruiting_vine"), "HZ(min) 9, HZ(max) 11;" +
                "⚠ can be grown in colder biomes if under glass");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "caatinga_passion_fruit_vine"), "HZ(min) 9, HZ(max) 13 (2F);" +
                "⚠ can be grown in colder biomes if under glass");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "caatinga_passion_fruit_flowering_vine"), "HZ(min) 9, HZ(max) 13 (2F);" +
                "⚠ can be grown in colder biomes if under glass");
        ...
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "brazillian_dutchman_pipe_vine"), "HZ(min) 10, HZ(max) 12;" +
                "⚠ can be grown in colder biomes if under glass");
        SAPLING_ZONES.put(new ResourceLocation("brbiomesmod", "podocarpus_lambertii_sapling"), "HZ(min) 9, HZ(max) 10;");
