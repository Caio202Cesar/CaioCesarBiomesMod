...
public class AncientFigFoliagePlacer extends FoliagePlacer {
    public static final Codec<AncientFigFoliagePlacer> CODEC =
            RecordCodecBuilder.create(instance ->
                    func_242830_b(instance)
                            .apply(instance, AncientFigFoliagePlacer::new));

    public AncientFigFoliagePlacer(FeatureSpread radius, FeatureSpread offset) {
        super(radius, offset);
    }

    @Override
    protected FoliagePlacerType<?> getPlacerType() {
        return ModFoliagePlacer.ANCIENT_FIG_FOLIAGE_PLACER.get();
    }
    ...
    private void placeLeaf(
        ...
        if (TreeFeature.isReplaceableAt(world, pos)) {
            ...
            world.setBlockState(
                    pos,
                    TreeBlocks.SYCAMORE_FIG_LEAVES.get()
                            .getDefaultState()
