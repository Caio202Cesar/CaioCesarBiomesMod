...
public class ChileanBellflowerPinkTrunkDecorator extends TreeDecorator {
    public static final Codec<ChileanBellflowerPinkTrunkDecorator> CODEC =
            Codec.floatRange(0.0F, 1.0F)
                    .fieldOf("probability")
                    .xmap(ChileanBellflowerPinkTrunkDecorator::new,
                            decorator -> decorator.probability)
                    .codec();

    private final float probability;

    public ChileanBellflowerPinkTrunkDecorator(float probability) {
        ...
        trunkPositions.forEach(pos -> {
            ...
            if (rand.nextInt(3) > 0) {
                ...
                if (Feature.isAirAt(world, west)) {
                    placeVine(world, west, ChileanBellflowerPink.EAST, placed, boundingBox);
                }
            }
            ...
            if (rand.nextInt(3) > 0) {
                ...
                if (Feature.isAirAt(world, east)) {
                    placeVine(world, east, ChileanBellflowerPink.WEST, placed, boundingBox);
                }
            }
            ...
            if (rand.nextInt(3) > 0) {
                ...
                if (Feature.isAirAt(world, north)) {
                    placeVine(world, north, ChileanBellflowerPink.SOUTH, placed, boundingBox);
                }
            }
            ...
            if (rand.nextInt(3) > 0) {
                ...
                if (Feature.isAirAt(world, south)) {
                    placeVine(world, south, ChileanBellflowerPink.NORTH, placed, boundingBox);
                }
            }
        });
    }
    ...
    private void placeVine(IWorldGenerationReader world, BlockPos pos,
        ...
        BlockState vineState = ModPlants.CHILEAN_BELLFLOWER_PINK.get()
                .getDefaultState()
                .with(property, true);
