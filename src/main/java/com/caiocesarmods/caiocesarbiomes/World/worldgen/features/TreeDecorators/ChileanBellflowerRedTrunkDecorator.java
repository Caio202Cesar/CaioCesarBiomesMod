...
public class ChileanBellflowerRedTrunkDecorator extends TreeDecorator {
    public static final Codec<ChileanBellflowerRedTrunkDecorator> CODEC =
            Codec.floatRange(0.0F, 1.0F)
                    .fieldOf("probability")
                    .xmap(ChileanBellflowerRedTrunkDecorator::new,
                            decorator -> decorator.probability)
                    .codec();

    private final float probability;

    public ChileanBellflowerRedTrunkDecorator(float probability) {
        ...
        trunkPositions.forEach(pos -> {
            ...
            if (rand.nextInt(3) > 0) {
                ...
                if (Feature.isAirAt(world, west)) {
                    placeVine(world, west, ChileanBellflowerRed.EAST, placed, boundingBox);
                }
            }
            ...
            if (rand.nextInt(3) > 0) {
                ...
                if (Feature.isAirAt(world, east)) {
                    placeVine(world, east, ChileanBellflowerRed.WEST, placed, boundingBox);
                }
            }
            ...
            if (rand.nextInt(3) > 0) {
                ...
                if (Feature.isAirAt(world, north)) {
                    placeVine(world, north, ChileanBellflowerRed.SOUTH, placed, boundingBox);
                }
            }
            ...
            if (rand.nextInt(3) > 0) {
                ...
                if (Feature.isAirAt(world, south)) {
                    placeVine(world, south, ChileanBellflowerRed.NORTH, placed, boundingBox);
                }
            }
        });
    }
    ...
    private void placeVine(IWorldGenerationReader world, BlockPos pos,
        ...
        BlockState vineState = ModPlants.CHILEAN_BELLFLOWER_RED.get()
                .getDefaultState()
                .with(property, true);
