...
public class CreepingFigTrunkDecorator extends TreeDecorator {
    public static final Codec<CreepingFigTrunkDecorator> CODEC =
            Codec.floatRange(0.0F, 1.0F)
                    .fieldOf("probability")
                    .xmap(CreepingFigTrunkDecorator::new,
                            decorator -> decorator.probability)
                    .codec();

    private final float probability;

    public CreepingFigTrunkDecorator(float probability) {
        ...
        trunkPositions.forEach(pos -> {
            ...
            if (rand.nextInt(3) > 0) {
                ...
                if (Feature.isAirAt(world, west)) {
                    placeVine(world, west, CreepingFigVine.EAST, placed, boundingBox);
                }
            }
            ...
            if (rand.nextInt(3) > 0) {
                ...
                if (Feature.isAirAt(world, east)) {
                    placeVine(world, east, CreepingFigVine.WEST, placed, boundingBox);
                }
            }
            ...
            if (rand.nextInt(3) > 0) {
                ...
                if (Feature.isAirAt(world, north)) {
                    placeVine(world, north, CreepingFigVine.SOUTH, placed, boundingBox);
                }
            }
            ...
            if (rand.nextInt(3) > 0) {
                ...
                if (Feature.isAirAt(world, south)) {
                    placeVine(world, south, CreepingFigVine.NORTH, placed, boundingBox);
                }
            }
        });
    }
    ...
    private void placeVine(IWorldGenerationReader world, BlockPos pos,
        ...
        BlockState vineState = ModPlants.CREEPING_FIG_VINE.get()
                .getDefaultState()
                .with(property, true);
