...
public class GloriosaTrunkDecorator extends TreeDecorator {
    public static final Codec<GloriosaTrunkDecorator> CODEC =
            Codec.floatRange(0.0F, 1.0F)
                    .fieldOf("probability")
                    .xmap(GloriosaTrunkDecorator::new,
                            decorator -> decorator.probability)
                    .codec();

    private final float probability;

    public GloriosaTrunkDecorator(float probability) {
        ...
        trunkPositions.forEach(pos -> {
            ...
            if (rand.nextInt(3) > 0) {
                ...
                if (Feature.isAirAt(world, west)) {
                    placeVine(world, west, GloriosaLily.EAST, placed, boundingBox);
                }
            }
            ...
            if (rand.nextInt(3) > 0) {
                ...
                if (Feature.isAirAt(world, east)) {
                    placeVine(world, east, GloriosaLily.WEST, placed, boundingBox);
                }
            }
            ...
            if (rand.nextInt(3) > 0) {
                ...
                if (Feature.isAirAt(world, north)) {
                    placeVine(world, north, GloriosaLily.SOUTH, placed, boundingBox);
                }
            }
            ...
            if (rand.nextInt(3) > 0) {
                ...
                if (Feature.isAirAt(world, south)) {
                    placeVine(world, south, GloriosaLily.NORTH, placed, boundingBox);
                }
            }
        });
    }
