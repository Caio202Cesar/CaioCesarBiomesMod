...
public class KiwiGoldVineTrunkDecorator extends TreeDecorator {
    public static final Codec<KiwiGoldVineTrunkDecorator> CODEC = Codec.unit(KiwiGoldVineTrunkDecorator::new);
    public static final KiwiGoldVineTrunkDecorator INSTANCE = new KiwiGoldVineTrunkDecorator();
