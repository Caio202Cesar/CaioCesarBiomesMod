...
public class ModTreeDecorators {
    ...
    public static final RegistryObject<TreeDecoratorType<KiwiGoldVineTrunkDecorator>> KIWI_GOLD_VINE_TRUNK_DECORATOR =
            TREE_DECORATORS.register("kiwi_gold_vine_trunk_decorator",
                    () -> new TreeDecoratorType<>(KiwiGoldVineTrunkDecorator.CODEC));
    ...
    public static final RegistryObject<TreeDecoratorType<ChileanBellflowerRedTrunkDecorator>> CHILEAN_BELLFLOWER_RED_TRUNK_DECORATOR =
            TREE_DECORATORS.register("chilean_bellflower_red_trunk_decorator",
                    () -> new TreeDecoratorType<>(ChileanBellflowerRedTrunkDecorator.CODEC));

    public static final RegistryObject<TreeDecoratorType<ChileanBellflowerPinkTrunkDecorator>> CHILEAN_BELLFLOWER_PINK_TRUNK_DECORATOR =
            TREE_DECORATORS.register("chilean_bellflower_pink_trunk_decorator",
                    () -> new TreeDecoratorType<>(ChileanBellflowerPinkTrunkDecorator.CODEC));

    public static final RegistryObject<TreeDecoratorType<ChileanBellflowerWhiteTrunkDecorator>> CHILEAN_BELLFLOWER_WHITE_TRUNK_DECORATOR =
            TREE_DECORATORS.register("chilean_bellflower_white_trunk_decorator",
                    () -> new TreeDecoratorType<>(ChileanBellflowerWhiteTrunkDecorator.CODEC));

    public static final RegistryObject<TreeDecoratorType<ChileanBellflowerMagentaTrunkDecorator>> CHILEAN_BELLFLOWER_MAGENTA_TRUNK_DECORATOR =
