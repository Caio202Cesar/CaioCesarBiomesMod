...
public class PeppercornVineTrunkDecorator extends TreeDecorator {
    public static final Codec<PeppercornVineTrunkDecorator> CODEC =
            Codec.floatRange(0.0F, 1.0F)
                    .fieldOf("probability")
                    .xmap(PeppercornVineTrunkDecorator::new,
                            decorator -> decorator.probability)
                    .codec();

    private final float probability;

    public PeppercornVineTrunkDecorator(float probability) {
        ...
        trunkPositions.forEach(pos -> {
            ...
            if (rand.nextInt(3) > 0) {
                ...
                if (Feature.isAirAt(world, west)) {
                    placeVine(world, west, PeppercornVine.EAST, placed, boundingBox);
                }
            }
            ...
            if (rand.nextInt(3) > 0) {
                ...
                if (Feature.isAirAt(world, east)) {
                    placeVine(world, east, PeppercornVine.WEST, placed, boundingBox);
                }
            }
            ...
            if (rand.nextInt(3) > 0) {
                ...
                if (Feature.isAirAt(world, north)) {
                    placeVine(world, north, PeppercornVine.SOUTH, placed, boundingBox);
                }
            }
            ...
            if (rand.nextInt(3) > 0) {
                ...
                if (Feature.isAirAt(world, south)) {
                    placeVine(world, south, PeppercornVine.NORTH, placed, boundingBox);
                }
            }
        });
    }
    ...
    private void placeVine(IWorldGenerationReader world, BlockPos pos,
        ...
        BlockState vineState = ModPlants.PEPPERCORN_VINE.get()
                .getDefaultState()
                .with(property, true);
