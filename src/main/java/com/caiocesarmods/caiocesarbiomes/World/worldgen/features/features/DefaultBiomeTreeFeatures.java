...
public class DefaultBiomeTreeFeatures {
    ...
    public static final ConfiguredFeature<?, ?> MEDITERRANEAN_OAK_SHRUBS = register("mediterranean_oak_shrubs",
            Feature.RANDOM_SELECTOR.withConfiguration(new MultipleRandomFeatureConfig(ImmutableList.of(
                    COMMON_MYRTLE_SHRUB.withChance(0.3F), MOCK_PRIVET_SHRUB.withChance(0.3F), MASTIC_SHRUB.withChance(0.24F)
                    //,MEDITERRANEAN_JUNIPER_SHRUB.withChance(0.24F)
    ...
    public static final ConfiguredFeature<?, ?> SUBTROPICAL_EVERGREEN_OAK_BEACH_TREES = register("subtropical_evergreen_oak_beach_trees",
            Feature.RANDOM_SELECTOR.withConfiguration(new MultipleRandomFeatureConfig(ImmutableList.of(POHUTUKAWA_TREE.withChance(0.36F),
                            ...
                            SABAL_PALM_TREE.withChance(0.2F), SOUTHERN_LIVE_OAK_TREE.withChance(0.36F),
                            SOUTHERN_WAX_MYRTLE_SHRUB.withChance(0.34F)), SAND_LAUREL_OAK_TREE))
                    .withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT)
                    .withPlacement(Placement.COUNT_EXTRA.configure(new AtSurfaceWithExtraConfig(6, 0.2F, 2))));
    ...
    public static final ConfiguredFeature<?, ?> MONTANE_CLOUD_JUNGLE_TREES = register("montane_cloud_jungle_trees",
            Feature.RANDOM_SELECTOR.withConfiguration(new MultipleRandomFeatureConfig(ImmutableList.of(OCOTEA_JUNGLE_TREE.withChance(0.2F),
                            ...
                            OCOTEA_JUNGLE_TREE_WITH_IVY.withChance(0.2F)), OCOTEA_JUNGLE_FANCY_TREE)).withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT)
                    .withPlacement(Placement.COUNT_EXTRA.configure(new AtSurfaceWithExtraConfig(10, 0.1F, 1))));
    ...
    public static final ConfiguredFeature<?, ?> SUBTROPICAL_JUNGLE_CONIFERS = register("subtropical_jungle_conifers",
            Feature.RANDOM_SELECTOR.withConfiguration(new MultipleRandomFeatureConfig(ImmutableList.of(
                            AGATHIS_TREE1.withChance(0.2F), AGATHIS_TREE2.withChance(0.2F),
                            BUNYA_PINE_TREE2.withChance(0.2F), BUNYA_PINE_TREE.withChance(0.2F)), HOOP_PINE_TREE))
                    .withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT)
    ...
    public static final ConfiguredFeature<?, ?> MIXED_CONTINENTAL_FOREST_TREES = register("mixed_continental_forest_trees",
            Feature.RANDOM_SELECTOR.withConfiguration(new MultipleRandomFeatureConfig(ImmutableList.of(ELDERBERRY_TREE.withChance(0.2F),
                            WHITE_CRABAPPLE_TREE.withChance(0.2F), ASPEN_TREE.withChance(0.2F), LOMBARDY_POPLAR_TREE.withChance(0.2F),
                            PINK_CRABAPPLE_TREE.withChance(0.2F), RED_CRABAPPLE_TREE.withChance(0.2F), RED_MAPLE_TREE.withChance(0.2F),
                            RED_MAPLE_FANCY_TREE.withChance(0.2F), WALNUT_TREE.withChance(0.2F), WALNUT_FANCY_TREE.withChance(0.2F),
                            RED_OAK_TREE.withChance(0.2F), RED_OAK_FANCY_TREE.withChance(0.2F), HAWTHORN_TREE.withChance(0.2F),
                            ROWAN_TREE.withChance(0.2F), BLACK_POPLAR_FANCY_TREE.withChance(0.2F), JUNIPER_SHRUB.withChance(0.2F),
                            CHERRY_PLUM_FANCY_TREE.withChance(0.2F), CHERRY_PLUM_TREE.withChance(0.2F), HAZELNUT_TREE.withChance(0.2F),
                            APPLE_TREE1.withChance(0.2F), APPLE_TREE2.withChance(0.2F), PLANE_TREE.withChance(0.2F), COOPER_BEECH_TREE.withChance(0.2F),
                            COOPER_BEECH_BIG_TREE.withChance(0.2F)), PLANE_FANCY_TREE)).withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT)
                    .withPlacement(Placement.COUNT_EXTRA.configure(new AtSurfaceWithExtraConfig(5, 0.1F, 1))));
    ...
    public static final ConfiguredFeature<?, ?> TEMPERATE_FRUIT_TREES = register("temperate_fruit_trees", Feature.RANDOM_SELECTOR
            .withConfiguration(new MultipleRandomFeatureConfig(ImmutableList.of(PINK_CRABAPPLE_TREE.withChance(0.5F), CHERRY_PLUM_TREE.withChance(0.1F),
                    CHERRY_PLUM_FANCY_TREE.withChance(0.3F), RED_CRABAPPLE_TREE.withChance(0.2F), MULBERRY_TREE.withChance(0.3F), APPLE_TREE1.withChance(0.38F),
    ...
    public static final ConfiguredFeature<?, ?> JAPANESE_GROVE_TREES = register("japanese_grove_trees", Feature.RANDOM_SELECTOR
            .withConfiguration(new MultipleRandomFeatureConfig(ImmutableList.of(SUPER_BIRCH_BEES_0002.withChance(0.3F),
                    ...
                    FANCY_OAK_TREE_WITH_IVY.withChance(0.198F), OAK.withChance(0.4F), APPLE_TREE1.withChance(0.28F),
                    APPLE_TREE2.withChance(0.18F), HAZELNUT_TREE.withChance(0.2F)), SPRUCE)).withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT)
    ...
    public static final ConfiguredFeature<?, ?> TEMPERATE_OCEANIC_FOREST_VEGETATION = register("forest_extra_vegetation",
            Feature.RANDOM_SELECTOR.withConfiguration(new MultipleRandomFeatureConfig(ImmutableList.of(PINK_CRABAPPLE_TREE.withChance(0.2F),
                            ...
                            COOPER_BEECH_TREE.withChance(0.2F), YOUNG_YEW_TREE.withChance(0.2F), BIG_YEW_TREE.withChance(0.2F),
                            BIG_YEW_TREE_WITH_IVY.withChance(0.2F), RED_OAK_SHRUB.withChance(0.2F),
    ...
    public static final ConfiguredFeature<?, ?> DARK_FOREST_EXTRA_VEGETATION = register("dark_oak_forest_extra_vegetation",
            Feature.RANDOM_SELECTOR.withConfiguration(new MultipleRandomFeatureConfig(ImmutableList.of(
                            ...
                            BIG_YEW_TREE.withChance(0.2F), BIG_YEW_TREE_WITH_IVY.withChance(0.2F),
                            ANCIENT_YEW_TREE.withChance(0.2F), DARK_OAK_WITH_IVY.withChance(0.2F), CHERRY_PLUM_FANCY_TREE.withChance(0.2F),
                            CHERRY_PLUM_TREE.withChance(0.2F), COOPER_BEECH_TREE.withChance(0.2F)), ANCIENT_YEW_TREE_WITH_IVY))
                    .withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT)
                    .withPlacement(Placement.COUNT_EXTRA.configure(new AtSurfaceWithExtraConfig(6, 0.1F, 1))));
    ...
    public static final ConfiguredFeature<?, ?> HEMIBOREAL_PRAIRIE_TREES = register("hemiboreal_prairie_trees",
            Feature.RANDOM_SELECTOR.withConfiguration(new MultipleRandomFeatureConfig(ImmutableList.of(BLACK_POPLAR_FANCY_TREE.withChance(0.5F),
                            ALMOND_TREE.withChance(0.4F), APPLE_TREE1.withChance(0.008F), APPLE_TREE2.withChance(0.0078F)), LOMBARDY_POPLAR_TREE)).withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT)
    ...
    public static final ConfiguredFeature<?, ?> TREES_TEMPERATE_RAINFOREST = register("trees_temperate_rainforest",
            Feature.RANDOM_SELECTOR.withConfiguration(new MultipleRandomFeatureConfig(ImmutableList.of(COOPER_BEECH_TREE.withChance(0.2F),
                            COOPER_BEECH_BIG_TREE.withChance(0.2F), OAK_TREE_WITH_IVY.withChance(0.2F),
                            FANCY_OAK_TREE_WITH_IVY.withChance(0.2F), FANCY_OAK.withChance(0.2F), OAK.withChance(0.2F),
                            OAK_BEES_002.withChance(0.2F), FANCY_OAK_BEES_005.withChance(0.2F),
                            RED_OAK_FANCY_TREE.withChance(0.2F), HAZELNUT_TREE.withChance(0.2F),
                            RED_MAPLE_TREE.withChance(0.2F), APPLE_TREE1.withChance(0.2F),
                            APPLE_TREE2.withChance(0.2F), BIG_YEW_TREE.withChance(0.2F),
                            BIG_YEW_TREE_WITH_IVY.withChance(0.2F),
                            OAK_TREE_WITH_KIWI.withChance(0.2F), RED_MAPLE_FANCY_TREE.withChance(0.2F),
                            YOUNG_YEW_TREE.withChance(0.2F), ANCIENT_YEW_TREE.withChance(0.2F),
                            HAWTHORN_TREE.withChance(0.2F), JAPANESE_MAPLE_TREE.withChance(0.2F),
    ...
    public static final ConfiguredFeature<?, ?> MOUNTAIN_EXTRA_VEGETATION = register("mountain_extra_vegetation",
            Feature.RANDOM_SELECTOR.withConfiguration(new MultipleRandomFeatureConfig(ImmutableList.of(BLUE_SPRUCE.withChance(0.078F),
                            HAWTHORN_TREE.withChance(0.012F), ROWAN_TREE.withChance(0.012F),
    ...
    public static final ConfiguredFeature<?, ?> HUMID_SUBTROPICAL_EUCALYPTUS_FOREST_TREES = register("humid_subtropical_eucalyptus_forest_trees",
            Feature.RANDOM_SELECTOR.withConfiguration(new MultipleRandomFeatureConfig(ImmutableList.of(LILLY_PILLY_TREE.withChance(0.22F),
                    ...
                    LILLY_PILLY_TREE)).withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT).withPlacement(Placement.COUNT_EXTRA
                    .configure(new AtSurfaceWithExtraConfig(13, 0.1F, 1))));
