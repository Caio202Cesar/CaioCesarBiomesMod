...
import static net.minecraft.world.gen.foliageplacer.FoliagePlacerType.*;

public class ItalianCypressFoliagePlacer extends FoliagePlacer {
    public static final Codec<ItalianCypressFoliagePlacer> CODEC = RecordCodecBuilder.create((p_242834_0_) -> {
        ...
        })).apply(p_242834_0_, ItalianCypressFoliagePlacer::new);
    });

    private final FeatureSpread height;

    public ItalianCypressFoliagePlacer(FeatureSpread p_i242002_1_, FeatureSpread p_i242002_2_, FeatureSpread p_i242002_3_) {
