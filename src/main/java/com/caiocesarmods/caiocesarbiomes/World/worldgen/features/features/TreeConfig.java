...
public class TreeConfig implements IFeatureConfig {
    public static final Codec<TreeConfig> CODEC = RecordCodecBuilder.create((codecRecorder) -> {
        ...
        })).apply(codecRecorder, TreeConfig::new);
    });
    ...
    TreeConfig(BlockStateProvider trunkProvider, BlockStateProvider leavesProvider, BlockStateProvider groundReplacementProvider, BlockStateProvider diskProvider, int minHeight, int maxHeight, int diskRadius, List<BlockState> whitelist) {
    ...
    public static class Builder {
        ...
        public Builder copy(TreeConfig config) {
        ...
        public TreeConfig build() {
            return new TreeConfig(this.trunkProvider, this.leavesProvider, this.groundReplacementProvider, this.diskProvider,
                    this.minHeight, this.maxPossibleHeight, this.diskRadius, this.whitelist.stream().map(Block::getDefaultState).collect(Collectors.toList()));
        }
    }
}
