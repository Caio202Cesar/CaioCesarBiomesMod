...
public class TreeFeatures {
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> ACACIA_TREE_WITH_GLORIOSA = register("acacia_with_gloriosa",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.ACACIA_LOG),
                    ...
                    new TwoLayerFeature(1, 0, 2)))
                    .setDecorators(ImmutableList.of(ModFeatures.Placements.GLORIOSA_VINE_PLACEMENT100)).setIgnoreVines().build()));
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> RED_OLEANDER_SHRUB = register("red_oleander_shrub",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(TreeFeatures.States.MILKWOOD_LOG),
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> MESQUITE_TREE = register("mesquite_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.MESQUITE_LOG),
                    new SimpleBlockStateProvider(States.MESQUITE_LEAVES),
                    new AcaciaFoliagePlacer(FeatureSpread.create(2), FeatureSpread.create(0)),
                    new ForkyTrunkPlacer(5, 2, 2),
                    new TwoLayerFeature(1, 0, 2)))
                    .setDecorators(ImmutableList.of(Features.Placements.BEES_0002_PLACEMENT)).setIgnoreVines().build()));
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> OLIVE_TREE = register("olive_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.OLIVE_LOG),
                    ...
                    new StraightTrunkPlacer(4, 2, 0),
                    new TwoLayerFeature(1, 0, 1))).setIgnoreVines().build()));
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> OLIVE_FANCY_TREE = register("olive_fancy_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.OLIVE_LOG),
                    new SimpleBlockStateProvider(States.OLIVE_LEAVES),
                    new FancyFoliagePlacer(FeatureSpread.create(2), FeatureSpread.create(4), 4),
                    new FancyTrunkPlacer(3, 11, 0),
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> TROPICAL_ALMOND_TREE = register("tropical_almond_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.TROPICAL_ALMOND_LOG),
                    ...
                    new TwoLayerFeature(2, 0, 1)))
                    .setDecorators(ImmutableList.of(ModFeatures.Placements.PEPPERCORN_VINE_PLACEMENT)).build()));
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> TROPICAL_ALMOND_FANCY_TREE = register("tropical_almond_fancy_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.TROPICAL_ALMOND_LOG),
                    new SimpleBlockStateProvider(States.TROPICAL_ALMOND_LEAVES),
                    new FancyFoliagePlacer(FeatureSpread.create(2), FeatureSpread.create(4), 4),
                    new FancyTrunkPlacer(3, 11, 0),
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> RED_CRAPE_MYRTLE_TREE = register("red_crape_myrtle_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.CRAPE_MYRTLE_LOG),
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> ALEPPO_PINE = register("aleppo_pine",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(TreeFeatures.States.STONE_PINE_LOG),
                    new SimpleBlockStateProvider(TreeFeatures.States.ALEPPO_PINE_LEAVES),
                    new FancyFoliagePlacer(FeatureSpread.create(2), FeatureSpread.create(0), 3),
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> MARITIME_PINE = register("maritime_pine",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(TreeFeatures.States.STONE_PINE_LOG),
                    ...
                    .setDecorators(ImmutableList.of(new AlterGroundTreeDecorator(new SimpleBlockStateProvider(States.PODZOL)))).build()));
    //Brutia Pine
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> BRUTIA_PINE_FANCY_TREE = register("brutia_pine_fancy_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.STONE_PINE_LOG),
                    new SimpleBlockStateProvider(States.BRUTIA_PINE_LEAVES),
                    new FancyFoliagePlacer(FeatureSpread.create(2), FeatureSpread.create(4), 4),
                    new FancyTrunkPlacer(3, 11, 0), new TwoLayerFeature(0, 0, 0,
                    OptionalInt.of(4)))).setIgnoreVines().setHeightmap(Heightmap.Type.MOTION_BLOCKING)
                    .setDecorators(ImmutableList.of(new AlterGroundTreeDecorator(new SimpleBlockStateProvider(States.PODZOL)))).build()));
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> BRUTIA_PINE_FORKY_TREE = register("brutia_pine_forky_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.STONE_PINE_LOG),
                    new SimpleBlockStateProvider(States.BRUTIA_PINE_LEAVES),
                    new AcaciaFoliagePlacer(FeatureSpread.create(2), FeatureSpread.create(0)),
                    new ForkyTrunkPlacer(5, 2, 2),
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> INDIAN_CORAL_TREE = register("indian_coral_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.ERYTHRINA_LOG),
                    ...
                    new StraightTrunkPlacer(4, 2, 0),
                    new TwoLayerFeature(1, 0, 1)))
                    .setDecorators(ImmutableList.of(Features.Placements.BEES_0002_PLACEMENT, ModFeatures.Placements.PEPPERCORN_VINE_PLACEMENT,
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> INDIAN_CORAL_FANCY_TREE = register("indian_coral_fancy_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.ERYTHRINA_LOG),
                    ...
                    new FancyTrunkPlacer(3, 11, 0), new TwoLayerFeature(0, 0, 0,
                    OptionalInt.of(4)))).setIgnoreVines().setDecorators(ImmutableList.of(Features.Placements.BEES_005_PLACEMENT,
                            ModFeatures.Placements.PEPPERCORN_VINE_PLACEMENT, ModFeatures.Placements.GLORIOSA_VINE_PLACEMENT))
                    .setHeightmap(Heightmap.Type.MOTION_BLOCKING).build()));
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> PINK_CRABAPPLE_TREE = register("pink_crabapple_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.SORBUS_LOG),
                    new SimpleBlockStateProvider(States.PINK_CRABAPPLE_BRANCHES),
                    new BlobFoliagePlacer(FeatureSpread.create(2), FeatureSpread.create(0), 3),
                    new StraightTrunkPlacer(4, 2, 0),
                    new TwoLayerFeature(1, 0, 1)))
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> WHITE_CRABAPPLE_TREE = register("white_crabapple_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.SORBUS_LOG),
                    new SimpleBlockStateProvider(States.WHITE_CRABAPPLE_BRANCHES),
                    new BlobFoliagePlacer(FeatureSpread.create(2), FeatureSpread.create(0), 3),
                    new StraightTrunkPlacer(4, 2, 0),
                    new TwoLayerFeature(1, 0, 1)))
                    .setDecorators(ImmutableList.of(Features.Placements.BEES_005_PLACEMENT)).setIgnoreVines().build()));
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> RED_CRABAPPLE_TREE = register("red_crabapple_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.SORBUS_LOG),
                    new SimpleBlockStateProvider(States.RED_CRABAPPLE_BRANCHES),
                    new BlobFoliagePlacer(FeatureSpread.create(2), FeatureSpread.create(0), 3),
                    new StraightTrunkPlacer(4, 2, 0),
                    new TwoLayerFeature(1, 0, 1)))
                    .setDecorators(ImmutableList.of(Features.Placements.BEES_005_PLACEMENT)).setIgnoreVines().build()));
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> SOUTHERN_LIVE_OAK_TREE = register("southern_live_oak_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.LIVE_OAK_LOG),
                    ...
                    .setDecorators(ImmutableList.of(ModFeatures.Placements.SPANISH_MOSS_PLACEMENT100,
                            ...
                            ModFeatures.Placements.RESURRECTION_FERN_PLACEMENT075)).build()));
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> BIG_LIVE_OAK_TREE = register("big_live_oak_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.LIVE_OAK_LOG),
                    ...
                    .setDecorators(ImmutableList.of(ModFeatures.Placements.SPANISH_MOSS_PLACEMENT100,
                            ModFeatures.Placements.CREEPING_FIG_VINE_TRUNK_PLACEMENT025,
                            ModFeatures.Placements.RESURRECTION_FERN_PLACEMENT095))
                    .setHeightmap(Heightmap.Type.MOTION_BLOCKING).setIgnoreVines().build()));
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> EUCALYPTUS_TALL_TREE = register("eucalyptus_tall_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.EUCALYPTUS_LOG),
                    ...
                    new TwoLayerFeature(1, 0, 1))).setIgnoreVines()
                    .setDecorators(ImmutableList.of(Features.Placements.BEES_002_PLACEMENT, ModFeatures.Placements.GLORIOSA_VINE_PLACEMENT)).build()));
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> PINE_LIKE_CASUARINA_TREE = register("pine_like_casuarina_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.CASUARINA_LOG),
                    ...
                    new SpruceFoliagePlacer(FeatureSpread.create(3, 0), FeatureSpread.create(3, 2),
                            FeatureSpread.create(3, 0)),
                    new StraightTrunkPlacer(16, 2, 1),
                    new TwoLayerFeature(2, 0, 2)))
                    .setDecorators(ImmutableList.of(new AlterGroundTreeDecorator(new SimpleBlockStateProvider(States.PODZOL)))).setIgnoreVines().build()));
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> CHERRY_PLUM_TREE = register("cherry_plum_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.PLUM_LOG),
                    new SimpleBlockStateProvider(States.CHERRY_PLUM_BRANCHES),
                    new BlobFoliagePlacer(FeatureSpread.create(2), FeatureSpread.create(0), 3),
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> LOMBARDY_POPLAR_TREE = register("lombardy_poplar_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.COTTONWOOD_LOG),
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> BLACK_POPLAR_FANCY_TREE = register("black_poplar_fancy_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(TreeFeatures.States.COTTONWOOD_LOG),
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> COOK_PINE_TREE = register("cook_pine_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.ARAUCARIA_LOG),
                    ...
                    new SpruceFoliagePlacer(FeatureSpread.create(2, 0), FeatureSpread.create(2, 2),
                            FeatureSpread.create(2, 0)),
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> NORFOLK_ISLAND_PINE_TREE = register("norfolk_island_pine_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.ARAUCARIA_LOG),
                    ...
                    new TwoLayerFeature(1, 1, 2)))
                    .setDecorators(ImmutableList.of(new AlterGroundTreeDecorator(new SimpleBlockStateProvider(States.PODZOL)),
                            ModFeatures.Placements.PEPPERCORN_VINE_PLACEMENT)).setIgnoreVines().build()));
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> BIG_YEW_TREE = register("big_yew_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.YEW_LOG),
                    ...
                    .setDecorators(ImmutableList.of(new AlterGroundTreeDecorator(new SimpleBlockStateProvider(States.PODZOL)))).build()));
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> BIG_YEW_TREE_WITH_IVY = register("big_yew_tree_ivy",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.YEW_LOG),
                    new SimpleBlockStateProvider(States.YEW_LEAVES),
                    new BlobFoliagePlacer(FeatureSpread.create(3), FeatureSpread.create(0), 3),
                    new MegaJungleTrunkPlacer(6, 2, 0),
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> ANCIENT_YEW_TREE = register("ancient_yew_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.YEW_LOG),
                    ...
                    .setDecorators(ImmutableList.of(new AlterGroundTreeDecorator(new SimpleBlockStateProvider(States.PODZOL)))).build()));
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> ANCIENT_YEW_TREE_WITH_IVY = register("ancient_yew_tree_with_ivy",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.YEW_LOG),
                    new SimpleBlockStateProvider(States.YEW_LEAVES),
                    new VirginianaFoliagePlacer(FeatureSpread.create(2), FeatureSpread.create(0)),
                    new UmbrellaTrunkPlacer(4, 4, 2, 5, 5),
    ...
    //Rowan Trees
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> ROWAN_TREE = register("rowan_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.SORBUS_LOG),
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> HAZELNUT_TREE = register("hazelnut_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.HAZELNUT_LOG),
                    new SimpleBlockStateProvider(States.HAZELNUT_BRANCHES),
                    new BlobFoliagePlacer(FeatureSpread.create(2), FeatureSpread.create(0), 3),
                    new StraightTrunkPlacer(4, 2, 0),
                    new TwoLayerFeature(1, 0, 1))).setIgnoreVines().build()));
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> SAUSAGE_TREE = register("sausage_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.SAUSAGE_TREE_LOG),
                    ...
                    new TwoLayerFeature(1, 0, 2)))
                    .setDecorators(ImmutableList.of(Features.Placements.BEES_0002_PLACEMENT,
                            ModFeatures.Placements.GLORIOSA_VINE_PLACEMENT)).setIgnoreVines().build()));
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> DURIAN_TREE = register("durian_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(TreeFeatures.States.JUNGLE_LOG),
                    ...
                    new FancyFoliagePlacer(FeatureSpread.create(2), FeatureSpread.create(4), 4),
                    new FancyTrunkPlacer(10, 11, 3), new TwoLayerFeature(0, 0, 0,
                    OptionalInt.of(4)))).setIgnoreVines().setHeightmap(Heightmap.Type.MOTION_BLOCKING).setIgnoreVines()
                    .setDecorators(ImmutableList.of(ModFeatures.Placements.PEPPERCORN_VINE_PLACEMENT,
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> TALL_BISMARCK_PALM = register("bismarck_palm_tall",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.BISMARCK_PALM_LOG),
                    ...
                    new TwoLayerFeature(1, 0, 1)))
                    .setDecorators(ImmutableList.of(ModFeatures.Placements.GLORIOSA_VINE_PLACEMENT)).build()));
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> SUBALPINE_FIR = register("subalpine_fir",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.FIR_LOG),
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> SLASH_PINE = register("slash_pine",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(TreeFeatures.States.YELLOW_PINE_LOG),
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> TALL_LOBLOLLY_PINE = register("tall_loblolly_pine",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.YELLOW_PINE_LOG),
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> PEPPERCORN_JUNGLE_TREE = register("peppercorn_jungle_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.JUNGLE_LOG),
                    ...
                    new TwoLayerFeature(1, 0, 1)))
                    .setDecorators(ImmutableList.of(ModFeatures.Placements.PEPPERCORN_VINE_PLACEMENT100))
                    .setIgnoreVines().build()));

    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> GLORIOSA_JUNGLE_TREE = register("gloriosa_jungle_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.JUNGLE_LOG),
                    new SimpleBlockStateProvider(States.JUNGLE_LEAVES),
                    new BlobFoliagePlacer(FeatureSpread.create(2), FeatureSpread.create(0), 3),
                    new StraightTrunkPlacer(4, 8, 0),
                    new TwoLayerFeature(1, 0, 1)))
                    .setDecorators(ImmutableList.of(ModFeatures.Placements.GLORIOSA_VINE_PLACEMENT100))
                    .setIgnoreVines().build()));
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> MEGA_BALD_CYPRESS = register("mega_bald_cypress",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.BALD_CYPRESS_LOG),
                    ...
                    new TwoLayerFeature(1, 1, 2)))
                    .setDecorators(ImmutableList.of(new AlterGroundTreeDecorator(new SimpleBlockStateProvider(States.PODZOL)),
                            ModFeatures.Placements.SPANISH_MOSS_PLACEMENT075, ModFeatures.Placements.SPANISH_MOSS_PLACEMENT))
                    .setMaxWaterDepth(2).setIgnoreVines().build()));
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> ASPEN_TREE = register("aspen_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.ASPEN_LOG),
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> PEACH_TREE = register("peach_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.PLUM_LOG),
                    new SimpleBlockStateProvider(States.PEACH_BRANCHES),
                    new AcaciaFoliagePlacer(FeatureSpread.create(2), FeatureSpread.create(0)),
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> YELLOW_OLEANDER_TREE = register("yellow_oleander_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.MILKWOOD_LOG),
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> PINK_IVORY_TREE = register("pink_ivory_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.PINK_IVORY_LOG),
                    ...
                    new StraightTrunkPlacer(4, 2, 0),
                    new TwoLayerFeature(1, 0, 1)))
                    .setDecorators(ImmutableList.of(Features.Placements.BEES_005_PLACEMENT, ModFeatures.Placements.PEPPERCORN_VINE_PLACEMENT,
                            ModFeatures.Placements.GLORIOSA_VINE_PLACEMENT)).setIgnoreVines().build()));
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> COIHUE_TREE = register("coihue_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.NOTHOFAGUS_LOG),
                    ...
                    OptionalInt.of(4)))).setHeightmap(Heightmap.Type.MOTION_BLOCKING).build()));
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> COIHUE_TREE_WITH_BELLFLOWER = register("coihue_tree_with_bellflower",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.NOTHOFAGUS_LOG),
                    new SimpleBlockStateProvider(States.COIHUE_LEAVES),
                    new FancyFoliagePlacer(FeatureSpread.create(2), FeatureSpread.create(4), 4),
                    new FancyTrunkPlacer(4, 17, 0), new TwoLayerFeature(0, 0, 0,
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> CAMPHOR_TREE = register("camphor_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.CAMPHOR_LOG),
                    ...
                    .setDecorators(ImmutableList.of(Features.Placements.BEES_005_PLACEMENT,
                            ModFeatures.Placements.SPANISH_MOSS_PLACEMENT, ModFeatures.Placements.CREEPING_FIG_VINE_TRUNK_PLACEMENT025)).build()));
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> BIG_CAMPHOR_TREE = register("big_camphor_tree",
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> RING_CUPPED_OAK_TREE = register("ring_cupped_oak_tree",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.RING_CUPPED_OAK_LOG),
                    ...
                    .setDecorators(ImmutableList.of(Features.Placements.BEES_002_PLACEMENT,
                            ModFeatures.Placements.SPANISH_MOSS_PLACEMENT, ModFeatures.Placements.CREEPING_FIG_VINE_TRUNK_PLACEMENT025,
                            ModFeatures.Placements.KIWI_VINE_PLACEMENT)).setIgnoreVines().build()));
    ...
    //Apple Tree
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> APPLE_TREE1 = register("apple_tree1",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.SORBUS_LOG),
                    new SimpleBlockStateProvider(States.APPLE_BRANCHES),
                    new BlobFoliagePlacer(FeatureSpread.create(2), FeatureSpread.create(0), 3),
                    new StraightTrunkPlacer(4, 2, 0),
                    new TwoLayerFeature(1, 0, 1)))
                    .setDecorators(ImmutableList.of(Features.Placements.BEES_005_PLACEMENT)).setIgnoreVines().build()));
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> APPLE_TREE2 = register("apple_tree2",
            Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.SORBUS_LOG),
                    new SimpleBlockStateProvider(States.APPLE_BRANCHES),
                    new BlobFoliagePlacer(FeatureSpread.create(3), FeatureSpread.create(0), 3),
                    new StraightTrunkPlacer(4, 2, 0),
    ...
    public static final class States {
        ...
        protected static final BlockState BLACKWOOD_ACACIA_LOG = ModWood.BLACKWOOD_ACACIA_LOG.get().getDefaultState();
        protected static final BlockState BLACKWOOD_ACACIA_LEAVES = TreeBlocks.BLACKWOOD_ACACIA_LEAVES.get().getDefaultState();

        protected static final BlockState STONE_OAK_LOG = ModWood.STONE_OAK_LOG.get().getDefaultState();
        protected static final BlockState STONE_OAK_LEAVES = TreeBlocks.STONE_OAK_LEAVES.get().getDefaultState();

        protected static final BlockState RING_CUPPED_OAK_LOG = ModWood.RING_CUPPED_OAK_LOG.get().getDefaultState();
        protected static final BlockState RING_CUPPED_OAK_LEAVES = TreeBlocks.RING_CUPPED_OAK_LEAVES.get().getDefaultState();

        protected static final BlockState SAND_LAUREL_OAK_LOG = ModWood.SAND_LAUREL_OAK_LOG.get().getDefaultState();
        protected static final BlockState SAND_LAUREL_OAK_LEAVES = TreeBlocks.SAND_LAUREL_OAK_LEAVES.get().getDefaultState();

        protected static final BlockState RAINBOW_EUCALYPTUS_LOG = ModWood.RAINBOW_EUCALYPTUS_LOG.get().getDefaultState();
        ...
        protected static final BlockState CASTANOPSIS_LOG = ModWood.CASTANOPSIS_LOG.get().getDefaultState();
        protected static final BlockState CASTANOPSIS_LEAVES = TreeBlocks.CASTANOPSIS_LEAVES.get().getDefaultState();

        protected static final BlockState CHUSQUEA_BAMBOO_LOG = ModWood.CHUSQUEA_BAMBOO_BLOCK.get().getDefaultState();
        ...
        protected static final BlockState CHAMPAK_LOG = ModWood.CHAMPAK_LOG.get().getDefaultState();
        protected static final BlockState CHAMPAK_LEAVES = TreeBlocks.CHAMPAK_LEAVES.get().getDefaultState();

        protected static final BlockState PLUM_LOG = ModWood.PRUNUS_LOG.get().getDefaultState();
        protected static final BlockState CHERRY_PLUM_BRANCHES = TreeBlocks.CHERRY_PLUM_WINTER_BRANCHES.get().getDefaultState();
        protected static final BlockState PEACH_BRANCHES = TreeBlocks.PEACH_WINTER_BRANCHES.get().getDefaultState();
        protected static final BlockState ALMOND_BLOSSOM = TreeBlocks.ALMOND_BLOSSOM.get().getDefaultState();

        protected static final BlockState BALD_CYPRESS_LOG = ModWood.BALD_CYPRESS_LOG.get().getDefaultState();
        protected static final BlockState BALD_CYPRESS_LEAVES = TreeBlocks.BALD_CYPRESS_LEAVES.get().getDefaultState();

        protected static final BlockState LARCH_LOG = ModWood.LARCH_LOG.get().getDefaultState();
        protected static final BlockState LARCH_LEAVES = TreeBlocks.LARCH_LEAVES.get().getDefaultState();
        protected static final BlockState LARCH_TAIGA_SPRING_BRANCHES = TreeBlocks.LARCH_WINTER_BRANCHES.get().getDefaultState();

        protected static final BlockState PERSIMMON_LOG = ModWood.PERSIMMON_LOG.get().getDefaultState();
        ...
        protected static final BlockState FIR_LOG = ModWood.FIR_LOG.get().getDefaultState();
        ...
        protected static final BlockState MUGO_PINE_LOG = ModWood.MUGO_PINE_LOG.get().getDefaultState();
        protected static final BlockState MUGO_PINE_LEAVES = TreeBlocks.MUGO_PINE_LEAVES.get().getDefaultState();

        protected static final BlockState YELLOW_PINE_LOG = ModWood.YELLOW_PINE_LOG.get().getDefaultState();
        ...
        protected static final BlockState OIL_PALM_LOG = ModWood.OIL_PALM_LOG.get().getDefaultState();
        protected static final BlockState OIL_PALM_LEAVES = TreeBlocks.OIL_PALM_LEAVES.get().getDefaultState();

        protected static final BlockState WEEPING_WILLOW_LOG = ModWood.WEEPING_WILLOW_LOG.get().getDefaultState();
        ...
        protected static final BlockState BISMARCK_PALM_LOG = ModWood.BISMARCK_PALM_LOG.get().getDefaultState();
        protected static final BlockState BISMARCK_PALM_LEAVES = TreeBlocks.BISMARCK_PALM_LEAVES.get().getDefaultState();

        protected static final BlockState MARULA_LOG = ModWood.MARULA_LOG.get().getDefaultState();
        protected static final BlockState MARULA_LEAVES = TreeBlocks.MARULA_LEAVES.get().getDefaultState();

        protected static final BlockState HAZELNUT_LOG = ModWood.HAZELNUT_LOG.get().getDefaultState();
        protected static final BlockState HAZELNUT_BRANCHES = TreeBlocks.HAZELNUT_WINTER_BRANCHES.get().getDefaultState();

        protected static final BlockState SAUSAGE_TREE_LOG = ModWood.SAUSAGE_TREE_LOG.get().getDefaultState();
        ...
        protected static final BlockState PINK_CRABAPPLE_BRANCHES = TreeBlocks.PINK_CRABAPPLE_WINTER_BRANCHES.get().getDefaultState();
        protected static final BlockState WHITE_CRABAPPLE_BRANCHES = TreeBlocks.WHITE_CRABAPPLE_WINTER_BRANCHES.get().getDefaultState();
        ...
        protected static final BlockState PONDEROSA_PINE_LOG = ModWood.PONDEROSA_PINE_LOG.get().getDefaultState();
        protected static final BlockState PONDEROSA_PINE_LEAVES = TreeBlocks.PONDEROSA_PINE_LEAVES.get().getDefaultState();

        protected static final BlockState DOUGLAS_FIR_LOG = ModWood.DOUGLAS_FIR_LOG.get().getDefaultState();
        protected static final BlockState DOUGLAS_FIR_LEAVES = TreeBlocks.DOUGLAS_FIR_LEAVES.get().getDefaultState();

        protected static final BlockState GINKGO_LOG = ModWood.GINKGO_LOG.get().getDefaultState();
        protected static final BlockState GINKGO_LEAVES = TreeBlocks.GINKGO_LEAVES.get().getDefaultState();

        protected static final BlockState PINYON_LOG = ModWood.PINYON_LOG.get().getDefaultState();
        protected static final BlockState PINYON_LEAVES = TreeBlocks.PINYON_LEAVES.get().getDefaultState();

        protected static final BlockState CAROB_LOG = ModWood.CAROB_LOG.get().getDefaultState();
        protected static final BlockState CAROB_LEAVES = TreeBlocks.CAROB_LEAVES.get().getDefaultState();

        protected static final BlockState PLANE_LOG = ModWood.PLANE_LOG.get().getDefaultState();
        ...
        protected static final BlockState DATE_LOG = ModWood.DATE_LOG.get().getDefaultState();
        ...
        protected static final BlockState SOCOTRA_CUCUMBER_LOG = ModWood.SOCOTRA_CUCUMBER_LOG.get().getDefaultState();
        protected static final BlockState SOCOTRA_CUCUMBER_LEAVES = TreeBlocks.SOCOTRA_CUCUMBER_LEAVES.get().getDefaultState();

        protected static final BlockState YEW_LOG = ModWood.YEW_LOG.get().getDefaultState();
        protected static final BlockState YEW_LEAVES = TreeBlocks.YEW_LEAVES.get().getDefaultState();

        protected static final BlockState JAPANESE_PINE_LOG = ModWood.JAPANESE_PINE_LOG.get().getDefaultState();
        protected static final BlockState JAPANESE_PINE_LEAVES = TreeBlocks.JAPANESE_PINE_LEAVES.get().getDefaultState();

        protected static final BlockState DRAGON_BLOOD_LOG = ModWood.DRAGON_BLOOD_LOG.get().getDefaultState();
        protected static final BlockState DRAGON_BLOOD_LEAVES = TreeBlocks.DRAGON_BLOOD_LEAVES.get().getDefaultState();

        protected static final BlockState DESERT_ROSE_LOG = ModWood.SOCOTRA_DESERT_ROSE_LOG.get().getDefaultState();
        protected static final BlockState DESERT_ROSE_LEAVES = TreeBlocks.SOCOTRA_DESERT_ROSE_LEAVES.get().getDefaultState();

        protected static final BlockState BEECH_LOG = ModWood.BEECH_LOG.get().getDefaultState();
        protected static final BlockState COOPER_BEECH_LEAVES = TreeBlocks.COOPER_BEECH_LEAVES.get().getDefaultState();

        protected static final BlockState HEMLOCK_LOG = ModWood.HEMLOCK_LOG.get().getDefaultState();
        ...
        protected static final BlockState JUNGLE_FIG_LOG = ModWood.JUNGLE_FIG_LOG.get().getDefaultState();
        ...
        protected static final BlockState COAST_LIVE_OAK_LOG = ModWood.COAST_LIVE_OAK_LOG.get().getDefaultState();
        protected static final BlockState COAST_LIVE_OAK_LEAVES = TreeBlocks.COAST_LIVE_OAK_LEAVES.get().getDefaultState();

        protected static final BlockState LAUREL_OAK_LOG = ModWood.LAUREL_OAK_LOG.get().getDefaultState();
        ...
        protected static final BlockState COAST_COTTONWOOD_LOG = ModWood.COAST_COTTONWOOD_LOG.get().getDefaultState();
        protected static final BlockState COAST_COTTONWOOD_LEAVES = TreeBlocks.COAST_COTTONWOOD_LEAVES.get().getDefaultState();

        protected static final BlockState FIG_LOG = ModWood.FIG_LOG.get().getDefaultState();
        ...
        protected static final BlockState OLIVE_LOG = ModWood.OLIVE_LOG.get().getDefaultState();
        protected static final BlockState OLIVE_LEAVES = TreeBlocks.OLIVE_LEAVES.get().getDefaultState();

        protected static final BlockState ERYTHRINA_LOG = ModWood.ERYTHRINA_LOG.get().getDefaultState();
        protected static final BlockState INDIAN_CORAL_LEAVES = TreeBlocks.INDIAN_CORAL_LEAVES.get().getDefaultState();

        protected static final BlockState TROPICAL_ALMOND_LOG = ModWood.TROPICAL_ALMOND_LOG.get().getDefaultState();
        ...
        protected static final BlockState CRAPE_MYRTLE_LOG = ModWood.CRAPE_MYRTLE_LOG.get().getDefaultState();
        ...
        protected static final BlockState POMEGRANATE_LOG = ModWood.POMEGRANATE_LOG.get().getDefaultState();
        protected static final BlockState POMEGRANATE_LEAVES = TreeBlocks.POMEGRANATE_LEAVES.get().getDefaultState();

        protected static final BlockState BAYBERRY_LOG = ModWood.BAYBERRY_LOG.get().getDefaultState();
        protected static final BlockState SOUTHERN_WAX_MYRTLE_LEAVES = TreeBlocks.SOUTHERN_WAX_MYRTLE_LEAVES.get().getDefaultState();

        protected static final BlockState STONE_PINE_LOG = ModWood.MEDITERRANEAN_PINE_LOG.get().getDefaultState();
        ...
        protected static final BlockState BRUTIA_PINE_LEAVES = TreeBlocks.BRUTIA_PINE_LEAVES.get().getDefaultState();

        protected static final BlockState CHINESE_RED_PINE_LOG = ModWood.CHINESE_RED_PINE_LOG.get().getDefaultState();
        ...
        protected static final BlockState MULBERRY_LOG = ModWood.MULBERRY_LOG.get().getDefaultState();
        ...
        //protected static final BlockState RUSTY_GUM_LOG = ModWood.RUSTY_GUM_LOG.get().getDefaultState();
        //protected static final BlockState RUSTY_GUM_LEAVES = TreeBlocks.RUSTY_GUM_LEAVES.get().getDefaultState();

        protected static final BlockState CASUARINA_LOG = ModWood.CASUARINA_LOG.get().getDefaultState();
        ...
        protected static final BlockState NOTHOFAGUS_LOG = ModWood.NOTHOFAGUS_LOG.get().getDefaultState();
        ...
        protected static final BlockState PECAN_LOG = ModWood.PECAN_LOG.get().getDefaultState();
        protected static final BlockState PECAN_LEAVES = TreeBlocks.PECAN_LEAVES.get().getDefaultState();

        protected static final BlockState MANGO_LOG = ModWood.MANGO_LOG.get().getDefaultState();
        protected static final BlockState MANGO_LEAVES = TreeBlocks.MANGO_LEAVES.get().getDefaultState();

        protected static final BlockState WALNUT_LOG = ModWood.WALNUT_LOG.get().getDefaultState();
