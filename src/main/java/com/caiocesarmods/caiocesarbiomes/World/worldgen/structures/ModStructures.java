package com.caiocesarmods.caiocesarbiomes.World.worldgen.structures;
...
public class ModStructures {
    public static final DeferredRegister<Structure<?>> STRUCTURES =
            DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, CaioCesarBiomesMod.MOD_ID);

    public static final RegistryObject<Structure<NoFeatureConfig>> SOUTHERN_LIVE_OAK_TREE =
            STRUCTURES.register("southern_live_oak", SouthernLiveOakTree::new);
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(SOUTHERN_LIVE_OAK_TREE.get(),
                new StructureSeparationSettings(100,10, 1234567890),
                true);
    }
