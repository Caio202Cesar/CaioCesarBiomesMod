...
public class ModPlants {
    ...
    public static final RegistryObject<Block> HARDY_FURSCHIA = registerBlock("hardy_furschia",
            ModTallPlant::new);
    public static final RegistryObject<Block> SEA_OAT = registerBlock("sea_oat",
            ModTallPlant::new);
    ...
    public static final RegistryObject<Block> CHILEAN_BELLFLOWER_MAGENTA = registerBlock("chilean_bellflower_magenta",
            ChileanBellflowerMagenta::new);
    public static final RegistryObject<Block> CHILEAN_BELLFLOWER_PINK = registerBlock("chilean_bellflower_pink",
            ChileanBellflowerPink::new);
    ...
    /*public static final RegistryObject<Block> GRAPEVINE = registerBlock("grapevine",
            Grapevine::new);
    public static final RegistryObject<Block> GRAPEVINE_FRUITING = registerBlock("grapevine_fruiting",
            GrapevineFruiting::new);
    ...
    public static final RegistryObject<Block> KIWI_GOLD_VINE = registerBlock("kiwi_gold_vine",
            KiwiGoldVine::new);
    public static final RegistryObject<Block> KIWI_GOLD_FLOWERING_VINE = registerBlock("kiwi_gold_flowering_vine",
