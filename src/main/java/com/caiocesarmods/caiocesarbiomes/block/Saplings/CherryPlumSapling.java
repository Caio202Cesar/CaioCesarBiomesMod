...
public class CherryPlumSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModBlocks.CHERRY_PLUM_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModBlocks.POTTED_CHERRY_PLUM_SAPLING.get(), RenderType.getCutout());
