...
public class BlackPoplarSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModPlants.BLACK_POPLAR_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModPlants.POTTED_BLACK_POPLAR_SAPLING.get(), RenderType.getCutout());
