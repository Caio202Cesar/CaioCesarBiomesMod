...
public class BrutiaPineSapling extends SaplingBlock {
    public BrutiaPineSapling() {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.BRUTIA_PINE_SAPLING.get(), RenderType.getCutout());
    ...
    private static class BrutiaPineTree extends Tree {
        ...
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            if (random.nextInt(10) == 8) {
                return TreeFeatures.BRUTIA_PINE_FANCY_TREE;
            } else {
                return TreeFeatures.BRUTIA_PINE_FORKY_TREE;
            }
        }
    }
}
