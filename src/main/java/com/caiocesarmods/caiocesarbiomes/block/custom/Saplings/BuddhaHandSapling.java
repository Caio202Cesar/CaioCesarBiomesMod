...
public class BuddhaHandSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModBlocks.BUDDHA_HAND_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModBlocks.POTTED_BUDDHA_HAND_SAPLING.get(), RenderType.getCutout());
