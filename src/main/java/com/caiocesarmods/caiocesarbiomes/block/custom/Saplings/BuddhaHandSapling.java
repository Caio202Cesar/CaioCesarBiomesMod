...
public class BuddhaHandSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModPlants.BUDDHA_HAND_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModPlants.POTTED_BUDDHA_HAND_SAPLING.get(), RenderType.getCutout());
