...
public class BunyaPineSapling extends SaplingBlock {
    public BunyaPineSapling() {
        super(new BunyaPineSapling.BunyaPineTree(), Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.BUNYA_PINE_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_BUNYA_PINE_SAPLING.get(), RenderType.getCutout());
    ...
    private static class BunyaPineTree extends Tree {
        @Nullable
        @Override
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            if (random.nextInt(10) == 8) {
                ...
                return TreeFeatures.BUNYA_PINE_TREE2;
            }
        }
    }
}
