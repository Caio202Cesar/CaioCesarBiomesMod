...
public class CasuarinaSapling extends SaplingBlock {
    public CasuarinaSapling() {
        super(new CasuarinaSapling.CasuarinaTree(), AbstractBlock.Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.CASUARINA_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_CASUARINA_SAPLING.get(), RenderType.getCutout());
