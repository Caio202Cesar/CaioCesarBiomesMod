...
public class CherryPlumSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModPlants.CHERRY_PLUM_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModPlants.POTTED_CHERRY_PLUM_SAPLING.get(), RenderType.getCutout());
