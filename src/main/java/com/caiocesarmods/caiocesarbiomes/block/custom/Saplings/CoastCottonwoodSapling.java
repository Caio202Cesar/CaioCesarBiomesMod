...
public class CoastCottonwoodSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModPlants.COAST_COTTONWOOD_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModPlants.POTTED_COAST_COTTONWOOD_SAPLING.get(), RenderType.getCutout());
