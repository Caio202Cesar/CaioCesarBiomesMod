...
public class DarkPinkOleanderSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModPlants.OLEANDER_DARK_PINK_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModPlants.POTTED_OLEANDER_DARK_PINK_SAPLING.get(), RenderType.getCutout());
