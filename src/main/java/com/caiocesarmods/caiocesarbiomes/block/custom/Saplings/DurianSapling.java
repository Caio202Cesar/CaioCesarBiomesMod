...
public class DurianSapling extends SaplingBlock {
    public DurianSapling() {
        super(new DurianSapling.DurianTree(), Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
    ...
    private static class DurianTree extends Tree {
        @Nullable
        @Override
