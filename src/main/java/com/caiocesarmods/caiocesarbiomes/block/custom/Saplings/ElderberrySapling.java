...
public class ElderberrySapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModBlocks.ELDERBERRY_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModBlocks.POTTED_ELDERBERRY_SAPLING.get(), RenderType.getCutout());
