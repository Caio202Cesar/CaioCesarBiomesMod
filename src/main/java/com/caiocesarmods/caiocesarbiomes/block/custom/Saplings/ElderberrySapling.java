...
public class ElderberrySapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModPlants.ELDERBERRY_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModPlants.POTTED_ELDERBERRY_SAPLING.get(), RenderType.getCutout());
