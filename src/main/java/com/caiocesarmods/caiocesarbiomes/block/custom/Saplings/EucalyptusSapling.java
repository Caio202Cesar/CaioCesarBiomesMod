...
public class EucalyptusSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModPlants.EUCALYPTUS_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModPlants.POTTED_EUCALYPTUS_SAPLING.get(), RenderType.getCutout());
