...
public class HolmOakSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModPlants.HOLM_OAK_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModPlants.POTTED_HOLM_OAK_SAPLING.get(), RenderType.getCutout());
