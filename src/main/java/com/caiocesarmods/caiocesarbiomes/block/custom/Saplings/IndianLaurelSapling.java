...
public class IndianLaurelSapling extends SaplingBlock {
    public IndianLaurelSapling() {
        super(new IndianLaurelTree(), Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.INDIAN_LAUREL_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_INDIAN_LAUREL_SAPLING.get(), RenderType.getCutout());
    ...
    private static class IndianLaurelTree extends BigTree {
        @Nullable
        @Override
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            return TreeFeatures.INDIAN_LAUREL_TREE;
        }
        ...
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getHugeTreeFeature(Random rand) {
            return TreeFeatures.BIG_INDIAN_LAUREL_TREE;
        }
    }
}
