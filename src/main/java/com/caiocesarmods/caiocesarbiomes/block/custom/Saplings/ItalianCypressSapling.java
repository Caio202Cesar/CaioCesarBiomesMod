...
public class ItalianCypressSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModPlants.ITALIAN_CYPRESS_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModPlants.POTTED_ITALIAN_CYPRESS_SAPLING.get(), RenderType.getCutout());
