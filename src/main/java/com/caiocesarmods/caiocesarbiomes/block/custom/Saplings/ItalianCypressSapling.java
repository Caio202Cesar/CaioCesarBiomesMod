...
public class ItalianCypressSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.ITALIAN_CYPRESS_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_ITALIAN_CYPRESS_SAPLING.get(), RenderType.getCutout());
