...
public class JapaneseMapleSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModPlants.JAPANESE_MAPLE_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModPlants.POTTED_JAPANESE_MAPLE_SAPLING.get(), RenderType.getCutout());
