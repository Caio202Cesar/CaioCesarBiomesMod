...
public class LiveOakSapling extends SaplingBlock {
    public LiveOakSapling() {
        super(new LiveOakSapling.LiveOakTree(), AbstractBlock.Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.LIVE_OAK_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_LIVE_OAK_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.MOSSED_LIVE_OAK_SAPLING.get(), RenderType.getCutout());
    ...
    private static class LiveOakTree extends Tree {
        ...
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            return TreeFeatures.SOUTHERN_LIVE_OAK_TREE_WITHOUT_MOSS;
        }
    }
}
