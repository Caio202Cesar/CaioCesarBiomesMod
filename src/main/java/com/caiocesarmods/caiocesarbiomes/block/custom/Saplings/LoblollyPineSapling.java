...
public class LoblollyPineSapling extends SaplingBlock {
    public LoblollyPineSapling() {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.LOBLOLLY_PINE_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_LOBLOLLY_PINE_SAPLING.get(), RenderType.getCutout());
