...
public class MandarinSapling extends SaplingBlock {
    public MandarinSapling() {
        super(new MandarinSapling.MandarinTree(), AbstractBlock.Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.MANDARIN_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_MANDARIN_SAPLING.get(), RenderType.getCutout());
