...
public class MonkeyPuzzleSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModPlants.MONKEY_PUZZLE_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModPlants.POTTED_MONKEY_PUZZLE_SAPLING.get(), RenderType.getCutout());
