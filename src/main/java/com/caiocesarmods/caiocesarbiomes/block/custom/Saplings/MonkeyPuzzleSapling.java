...
public class MonkeyPuzzleSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.MONKEY_PUZZLE_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_MONKEY_PUZZLE_SAPLING.get(), RenderType.getCutout());
    ...
    private static class MonkeyPuzzleTree extends BigTree {
        @Nullable
        @Override
