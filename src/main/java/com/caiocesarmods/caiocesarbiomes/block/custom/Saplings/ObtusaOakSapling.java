...
public class ObtusaOakSapling extends SaplingBlock {
    public ObtusaOakSapling() {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.OBTUSA_OAK_SAPLING.get(), RenderType.getCutout());
    ...
    private static class ObtusaOakTree extends Tree {
        ...
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            return TreeFeatures.OBTUSA_OAK_TREE;
        }
    }
}
