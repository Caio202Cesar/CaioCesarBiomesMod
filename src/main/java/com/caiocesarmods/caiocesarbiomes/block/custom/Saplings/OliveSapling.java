...
public class OliveSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.OLIVE_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_OLIVE_SAPLING.get(), RenderType.getCutout());
    ...
    private static class OliveTree extends BigTree {
        ...
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            if (random.nextInt(10) == 0) {
                return TreeFeatures.OLIVE_FANCY_TREE;
            } else {
