...
public class OrangePlumeriaSapling extends SaplingBlock {
    public OrangePlumeriaSapling() {
        super(new OrangePlumeriaTree(), Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.ORANGE_PLUMERIA_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_ORANGE_PLUMERIA_SAPLING.get(), RenderType.getCutout());
    ...
    private static class OrangePlumeriaTree extends Tree {
        @Nullable
        @Override
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            return TreeFeatures.PLUMERIA_ORANGE_TREE;
        }
    }
}
