...
public class OrchidTreeSapling extends SaplingBlock {
    public OrchidTreeSapling() {
        super(new OrchidTreeTree(), Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.ORCHID_TREE_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_ORCHID_TREE_SAPLING.get(), RenderType.getCutout());
    ...
    private static class OrchidTreeTree extends Tree {
        @Nullable
        @Override
