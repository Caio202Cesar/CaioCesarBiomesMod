...
public class PinkCrapeMyrtleSapling extends SaplingBlock {
    public PinkCrapeMyrtleSapling() {
        super(new PinkCrapeMyrtleSapling.PinkCrapeMyrtleTree(), AbstractBlock.Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.PINK_CRAPE_MYRTLE_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_PINK_CRAPE_MYRTLE_SAPLING.get(), RenderType.getCutout());
    ...
    private static class PinkCrapeMyrtleTree extends Tree {
        @Nullable
        @Override
