...
public class PinkPlumeriaSapling extends SaplingBlock {
    public PinkPlumeriaSapling() {
        super(new PinkPlumeriaTree(), Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.PINK_PLUMERIA_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_PINK_PLUMERIA_SAPLING.get(), RenderType.getCutout());
    ...
    private static class PinkPlumeriaTree extends Tree {
        @Nullable
        @Override
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            return TreeFeatures.PLUMERIA_PINK_TREE;
        }
    }
}
