...
public class PinyonSapling extends SaplingBlock {
    public PinyonSapling() {
        super(new PinyonSapling.PinyonTree(), Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
    ...
    private static class PinyonTree extends Tree {
        @Nullable
        @Override
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            return TreeFeatures.PINYON_TREE;
        }
