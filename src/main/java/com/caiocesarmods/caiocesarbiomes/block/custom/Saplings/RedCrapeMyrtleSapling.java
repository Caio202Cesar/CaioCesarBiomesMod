...
public class RedCrapeMyrtleSapling extends SaplingBlock {
        public RedCrapeMyrtleSapling() {
            super(new RedCrapeMyrtleTree(), AbstractBlock.Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                    .sound(SoundType.PLANT));
        }

        @OnlyIn(Dist.CLIENT)
        public static void registerRenderLayer() {
            RenderTypeLookup.setRenderLayer(TreeBlocks.RED_CRAPE_MYRTLE_SAPLING.get(), RenderType.getCutout());
            RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_RED_CRAPE_MYRTLE_SAPLING.get(), RenderType.getCutout());
        }
    ...
    private static class RedCrapeMyrtleTree extends Tree {
            @Nullable
        @Override
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            return TreeFeatures.RED_CRAPE_MYRTLE_TREE;
        }
    }
}
