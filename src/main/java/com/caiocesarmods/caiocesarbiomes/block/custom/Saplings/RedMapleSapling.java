...
public class RedMapleSapling extends SaplingBlock {
    public RedMapleSapling() {
        super(new RedMapleTree(), Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.RED_MAPLE_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_RED_MAPLE_SAPLING.get(), RenderType.getCutout());
    ...
    private static class RedMapleTree extends Tree {
        @Nullable
        @Override
