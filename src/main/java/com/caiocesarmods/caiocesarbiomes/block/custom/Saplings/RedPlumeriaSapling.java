...
public class RedPlumeriaSapling extends SaplingBlock {
    public RedPlumeriaSapling() {
        super(new RedPlumeriaTree(), Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.RED_PLUMERIA_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_RED_PLUMERIA_SAPLING.get(), RenderType.getCutout());
    ...
    private static class RedPlumeriaTree extends Tree {
        @Nullable
        @Override
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            return TreeFeatures.PLUMERIA_RED_TREE;
        }
    }
}
