...
public class SocotraCucumberSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModBlocks.SOCOTRA_CUCUMBER_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModBlocks.POTTED_SOCOTRA_CUCUMBER_SAPLING.get(), RenderType.getCutout());
    ...
    private static class AvocadoTree extends Tree {
        ...
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            return TreeFeatures.SOCOTRA_CUCUMBER_TREE;
        }
    }
}
