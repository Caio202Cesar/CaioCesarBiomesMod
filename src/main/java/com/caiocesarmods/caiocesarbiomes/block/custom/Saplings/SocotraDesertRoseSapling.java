...
public class SocotraDesertRoseSapling extends SaplingBlock {
    public SocotraDesertRoseSapling() {
        super(new SocotraDesertRoseSapling.SocotraDesertRoseTree(), AbstractBlock.Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.SOCOTRA_DESERT_ROSE_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_SOCOTRA_DESERT_ROSE_SAPLING.get(), RenderType.getCutout());
    ...
    private static class SocotraDesertRoseTree extends Tree {
        @Nullable
        @Override
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            return TreeFeatures.SOCOTRA_DESERT_ROSE_TREE;
        }
    }
}
