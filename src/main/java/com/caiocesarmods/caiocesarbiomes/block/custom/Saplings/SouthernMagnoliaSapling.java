...
public class SouthernMagnoliaSapling extends SaplingBlock {
    public SouthernMagnoliaSapling() {
        super(new SouthernMagnoliaTree(), AbstractBlock.Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.SOUTHERN_MAGNOLIA_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_SOUTHERN_MAGNOLIA_SAPLING.get(), RenderType.getCutout());
    ...
    private static class SouthernMagnoliaTree extends Tree {
        @Nullable
        @Override
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            return TreeFeatures.SOUTHERN_MAGNOLIA_TREE;
        }
    }
}
