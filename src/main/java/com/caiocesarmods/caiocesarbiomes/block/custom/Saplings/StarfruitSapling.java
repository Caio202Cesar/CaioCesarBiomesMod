...
public class StarfruitSapling extends SaplingBlock {
    public StarfruitSapling() {
        super(new StarfruitSapling.StarfruitTree(), AbstractBlock.Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.STARFRUIT_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_STARFRUIT_SAPLING.get(), RenderType.getCutout());
    }
    ...
    private static class StarfruitTree extends Tree {
        @Nullable
        @Override
