...
public class SubalpineFirSapling extends SaplingBlock {
    public SubalpineFirSapling() {
        super(new SubalpineFirSapling.SubalpineFirTree(), Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.SUBALPINE_FIR_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_SUBALPINE_FIR_SAPLING.get(), RenderType.getCutout());
    ...
    private static class SubalpineFirTree extends Tree {
        @Nullable
        @Override
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            return TreeFeatures.SUBALPINE_FIR;
        }
    }
}
