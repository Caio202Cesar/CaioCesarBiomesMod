...
public class TahitiLimeSapling extends SaplingBlock {
    public TahitiLimeSapling() {
        super(new TahitiLimeSapling.TahitiLimeTree(), AbstractBlock.Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.TAHITI_LIME_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_TAHITI_LIME_SAPLING.get(), RenderType.getCutout());
    ...
    private static class TahitiLimeTree extends Tree {
        @Nullable
        @Override
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            return TreeFeatures.TAHITI_LIME_TREE;
        }
    }
}
