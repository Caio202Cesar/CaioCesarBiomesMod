...
public class TeaSapling extends SaplingBlock {
    public TeaSapling() {
        super(new TeaSapling.TeaTree(), Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.TEA_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_TEA_SAPLING.get(), RenderType.getCutout());
    ...
    private boolean isUnderGlass(ServerWorld world, BlockPos pos) {
        ...
        // (radius 1 → 3x3 very small green house)
    ...
    private static class TeaTree extends Tree {
        @Nullable
        @Override
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            return TreeFeatures.TEA_TREE;
        }
    }
}
