...
public class TeakSapling extends SaplingBlock {
    public TeakSapling() {
        super(new TeakSapling.TeakTree(), Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.TEAK_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_TEAK_SAPLING.get(), RenderType.getCutout());
    ...
    private static class TeakTree extends BigTree {
        @Nullable
        @Override
        ...
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getHugeTreeFeature(Random rand) {
            return TreeFeatures.MEGA_TEAK_TREE;
        }
    }
}
