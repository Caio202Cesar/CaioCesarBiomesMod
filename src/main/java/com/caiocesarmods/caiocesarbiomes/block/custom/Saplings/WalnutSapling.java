...
public class WalnutSapling extends SaplingBlock {
    public WalnutSapling() {
        super(new WalnutSapling.WalnutTree(), Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
    ...
    private static class WalnutTree extends Tree {
        @Nullable
        @Override
