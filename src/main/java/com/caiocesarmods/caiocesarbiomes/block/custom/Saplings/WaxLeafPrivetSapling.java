...
public class WaxLeafPrivetSapling extends SaplingBlock {
    public WaxLeafPrivetSapling() {
        super(new WaxLeafPrivetTree(), Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.WAX_LEAF_PRIVET_SAPLING.get(), RenderType.getCutout());
     ...
     * @param random
     */
    //Hardy to zone 7 to 10 (L. japonicum e L. lucidum)
    @Override
    ...
    private static class WaxLeafPrivetTree extends Tree {
        @Nullable
        @Override
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            return TreeFeatures.WAX_LEAF_PRIVET_TREE;
        }
    }
}
