...
public class WeepingFigSapling extends SaplingBlock {
    public WeepingFigSapling() {
        super(new WeepingFigTree(), Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.WEEPING_FIG_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_WEEPING_FIG_SAPLING.get(), RenderType.getCutout());
