...
public class WesternHemlockSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModPlants.WESTERN_HEMLOCK_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModPlants.POTTED_WESTERN_HEMLOCK_SAPLING.get(), RenderType.getCutout());
