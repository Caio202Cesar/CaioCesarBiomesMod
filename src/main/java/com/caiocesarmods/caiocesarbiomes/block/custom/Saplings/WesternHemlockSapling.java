...
public class WesternHemlockSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModBlocks.WESTERN_HEMLOCK_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModBlocks.POTTED_WESTERN_HEMLOCK_SAPLING.get(), RenderType.getCutout());
