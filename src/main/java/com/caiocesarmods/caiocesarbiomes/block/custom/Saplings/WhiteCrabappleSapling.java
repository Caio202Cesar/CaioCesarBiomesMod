...
public class WhiteCrabappleSapling extends SaplingBlock {
    public WhiteCrabappleSapling() {
        super(new WhiteCrabappleTree(), AbstractBlock.Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.WHITE_CRABAPPLE_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_WHITE_CRABAPPLE_SAPLING.get(), RenderType.getCutout());
