...
public class WhiteCrapeMyrtleSapling extends SaplingBlock {
        ...
        public static void registerRenderLayer() {
            RenderTypeLookup.setRenderLayer(ModBlocks.WHITE_CRAPE_MYRTLE_SAPLING.get(), RenderType.getCutout());
            RenderTypeLookup.setRenderLayer(ModBlocks.POTTED_WHITE_CRAPE_MYRTLE_SAPLING.get(), RenderType.getCutout());
