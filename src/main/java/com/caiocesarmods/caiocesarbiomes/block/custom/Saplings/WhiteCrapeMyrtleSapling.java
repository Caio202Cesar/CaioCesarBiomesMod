...
public class WhiteCrapeMyrtleSapling extends SaplingBlock {
        ...
        public static void registerRenderLayer() {
            RenderTypeLookup.setRenderLayer(TreeBlocks.WHITE_CRAPE_MYRTLE_SAPLING.get(), RenderType.getCutout());
            RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_WHITE_CRAPE_MYRTLE_SAPLING.get(), RenderType.getCutout());
