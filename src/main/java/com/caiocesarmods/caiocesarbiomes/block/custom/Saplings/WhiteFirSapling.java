...
public class WhiteFirSapling extends SaplingBlock {
    public WhiteFirSapling() {
        super(new WhiteFirSapling.WhiteFirTree(), Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.WHITE_FIR_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_WHITE_FIR_SAPLING.get(), RenderType.getCutout());
    ...
    //Hardy from 3 to 8 (requires cool summers and low downfall)
    @Override
    ...
    private static class WhiteFirTree extends Tree {
        @Nullable
        @Override
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            return TreeFeatures.WHITE_FIR;
        }
    }
}
