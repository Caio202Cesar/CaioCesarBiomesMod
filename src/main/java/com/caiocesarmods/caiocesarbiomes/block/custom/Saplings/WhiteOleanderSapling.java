...
public class WhiteOleanderSapling extends SaplingBlock {
    public WhiteOleanderSapling() {
        super(new WhiteOleanderShrub(), AbstractBlock.Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                    .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.OLEANDER_WHITE_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_OLEANDER_WHITE_SAPLING.get(), RenderType.getCutout());
    ...
    private static class WhiteOleanderShrub extends Tree {
        @Nullable
        @Override
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            return TreeFeatures.WHITE_OLEANDER_SHRUB;
        }
    }
}
