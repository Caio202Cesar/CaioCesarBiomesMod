...
public class WhitePlumeriaSapling extends SaplingBlock {
    public WhitePlumeriaSapling() {
        super(new WhitePlumeriaTree(), Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.WHITE_PLUMERIA_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_WHITE_PLUMERIA_SAPLING.get(), RenderType.getCutout());
    ...
    private static class WhitePlumeriaTree extends Tree {
        @Nullable
        @Override
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            return TreeFeatures.PLUMERIA_WHITE_TREE;
        }
    }
}
