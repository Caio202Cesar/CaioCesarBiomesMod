...
public class YellowPlumeriaSapling extends SaplingBlock {
    public YellowPlumeriaSapling() {
        super(new YellowPlumeriaTree(), Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreeBlocks.YELLOW_PLUMERIA_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreeBlocks.POTTED_YELLOW_PLUMERIA_SAPLING.get(), RenderType.getCutout());
    ...
    private static class YellowPlumeriaTree extends Tree {
        @Nullable
        @Override
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            return TreeFeatures.PLUMERIA_YELLOW_TREE;
        }
    }
}
