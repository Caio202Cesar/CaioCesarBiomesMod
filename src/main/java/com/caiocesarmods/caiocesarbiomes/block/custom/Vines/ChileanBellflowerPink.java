...
public class ChileanBellflowerPink extends VineBlock implements IForgeShearable {
    public ChileanBellflowerPink() {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModPlants.CHILEAN_BELLFLOWER_PINK.get(), RenderType.getCutout());
