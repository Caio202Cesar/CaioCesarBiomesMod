...
public class ChileanBellflowerWhite extends VineBlock implements IForgeShearable {
    public ChileanBellflowerWhite() {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModPlants.CHILEAN_BELLFLOWER_WHITE.get(), RenderType.getCutout());
