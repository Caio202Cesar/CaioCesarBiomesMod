...
public class CreepingFigVine extends VineBlock implements IForgeShearable {
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if (random.nextDouble() < chance) {
            ...
            BlockState newState = ModPlants.CREEPING_FIG_FRUITING_VINE.get().getDefaultState();

            worldIn.setBlockState(pos, ModPlants.CREEPING_FIG_FRUITING_VINE.get().getDefaultState());
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModPlants.CREEPING_FIG_VINE.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModPlants.CREEPING_FIG_FRUITING_VINE.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModPlants.CREEPING_FIG_RIPE_FRUITING_VINE.get(), RenderType.getCutout());
    }
