...
public class GloriosaLily extends VineBlock implements IForgeShearable {
    public GloriosaLily() {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModPlants.GLORIOSA_LILY.get(), RenderType.getCutout());
