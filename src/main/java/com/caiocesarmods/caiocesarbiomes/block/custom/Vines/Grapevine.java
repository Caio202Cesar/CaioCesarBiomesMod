...
public class Grapevine extends VineBlock implements IForgeShearable {
    public Grapevine() {
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if (temp <= 0.89F && "WINTER".equals(currentSeason) && random.nextInt(5) == 0) {
            ...
            BlockState newState = ModPlants.GRAPEVINE_FALL1.get().getDefaultState();

            worldIn.setBlockState(pos, ModPlants.GRAPEVINE_FALL1.get().getDefaultState());
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModPlants.GRAPEVINE.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModPlants.GRAPEVINE_BRANCHES.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModPlants.GRAPEVINE_FRUITING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModPlants.GRAPEVINE_FALL2.get(), RenderType.getCutout());
