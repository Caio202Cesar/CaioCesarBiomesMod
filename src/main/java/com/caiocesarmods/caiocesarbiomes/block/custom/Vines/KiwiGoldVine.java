...
public class KiwiGoldVine extends VineBlock implements IForgeShearable {
    public KiwiGoldVine() {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModPlants.KIWI_GOLD_FLOWERING_VINE.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModPlants.KIWI_GOLD_VINE.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModPlants.KIWI_GOLD_FRUITING_VINE.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModPlants.KIWI_GOLD_WINTER_DRY_VINE.get(), RenderType.getCutout());
