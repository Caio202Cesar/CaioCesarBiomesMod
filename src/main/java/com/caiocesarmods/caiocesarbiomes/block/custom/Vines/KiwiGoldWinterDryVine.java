...
public class KiwiGoldWinterDryVine extends VineBlock implements IForgeShearable {
    public KiwiGoldWinterDryVine() {
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if ("SPRING".equals(currentSeason) && random.nextInt(15) == 0) {
            ...
            BlockState newState = ModPlants.KIWI_GOLD_FLOWERING_VINE.get().getDefaultState();

            worldIn.setBlockState(pos, ModPlants.KIWI_GOLD_FLOWERING_VINE.get().getDefaultState());
