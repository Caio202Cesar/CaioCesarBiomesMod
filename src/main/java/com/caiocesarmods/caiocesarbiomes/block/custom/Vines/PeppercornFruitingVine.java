...
public class PeppercornFruitingVine extends VineBlock implements IForgeShearable {
    public PeppercornFruitingVine() {
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if (random.nextDouble() < chance) {
            ...
            BlockState newState = ModPlants.PEPPERCORN_RIPE_FRUITING_VINE.get().getDefaultState();

            worldIn.setBlockState(pos, ModPlants.PEPPERCORN_RIPE_FRUITING_VINE.get().getDefaultState());
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        if (!worldIn.isRemote) {
            ...
            ItemStack itemStack = new ItemStack(ModItems.PEPPERCORN.get());
