...
public class PeppercornRipeFruitingVine extends VineBlock implements IForgeShearable {
    public PeppercornRipeFruitingVine() {
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        if (!worldIn.isRemote) {
            ...
            ItemStack itemStack = new ItemStack(ModItems.RIPE_PEPPERCORN.get());
