...
public class AlmondBlossom extends LeavesBlock implements IForgeShearable {
    ...
    public AlmondBlossom(Properties properties, Supplier<Block> nextStage) {
        super(properties);
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if (temp >= 0.7F && "SPRING".equals(currentSeason) && nextStage != null && random.nextInt(5) == 0) {
        ...
        if (temp <= 0.69F && "LATE_SPRING".equals(phase) && nextStage != null && random.nextInt(5) == 0) {
