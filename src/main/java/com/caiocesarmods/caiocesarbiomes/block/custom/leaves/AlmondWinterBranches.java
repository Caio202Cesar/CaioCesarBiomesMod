...
public class AlmondWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public AlmondWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
