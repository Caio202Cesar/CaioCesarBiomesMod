...
public class AppleWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public AppleWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
