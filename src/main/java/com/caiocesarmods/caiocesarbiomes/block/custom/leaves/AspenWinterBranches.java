...
public class AspenWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public AspenWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
