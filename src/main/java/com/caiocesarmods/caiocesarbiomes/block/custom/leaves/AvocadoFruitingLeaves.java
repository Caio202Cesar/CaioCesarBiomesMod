...
public class AvocadoFruitingLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public AvocadoFruitingLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if (temp <= 0.89F && "FALL".equals(currentSeason) && nextStage != null && random.nextInt(25) == 0) {
            ...
            ItemStack itemStack = new ItemStack(ModItems.AVOCADO.get(), dropCount);
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        if (!worldIn.isRemote) {
            ...
            worldIn.setBlockState(pos, TreeBlocks.AVOCADO_LEAVES.get().getDefaultState());
