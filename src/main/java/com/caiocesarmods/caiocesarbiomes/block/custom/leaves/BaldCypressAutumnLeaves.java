...
public class BaldCypressAutumnLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public BaldCypressAutumnLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
