...
public class BaldCypressWinterLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public BaldCypressWinterLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
