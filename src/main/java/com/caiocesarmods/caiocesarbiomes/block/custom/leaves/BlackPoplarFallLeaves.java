...
public class BlackPoplarFallLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public BlackPoplarFallLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
