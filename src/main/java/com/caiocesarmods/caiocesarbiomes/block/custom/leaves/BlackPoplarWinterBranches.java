...
public class BlackPoplarWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public BlackPoplarWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
