...
public class CarobFruitingLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public CarobFruitingLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if ("WINTER".equals(currentSeason) && nextStage != null && random.nextInt(25) == 0) {
            ...
            ItemStack itemStack = new ItemStack(ModItems.CAROB_BEANS.get(), dropCount);
        ...
        if ("EARLY_SUMMER".equals(phase) && nextStage != null && random.nextInt(2) == 0) {
        ...
        if ("MID_SUMMER".equals(phase) && nextStage != null && random.nextInt(2) == 0) {
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        if (!worldIn.isRemote) {
            ...
            worldIn.setBlockState(pos, TreeBlocks.CAROB_LEAVES.get().getDefaultState());
