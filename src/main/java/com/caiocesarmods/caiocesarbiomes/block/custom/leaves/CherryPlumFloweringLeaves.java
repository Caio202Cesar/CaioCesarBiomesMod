...
public class CherryPlumFloweringLeaves extends LeavesBlock implements IForgeShearable {
    public CherryPlumFloweringLeaves(Properties properties) {
        super(properties);
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if ("WINTER".equals(currentSeason) && random.nextInt(2) == 0) {
            ...
            worldIn.setBlockState(pos, TreeBlocks.CHERRY_PLUM_WINTER_BRANCHES.get()
                    .getDefaultState().with(LeavesBlock.DISTANCE, distance).with(LeavesBlock.PERSISTENT, persistent), 3);
        }
