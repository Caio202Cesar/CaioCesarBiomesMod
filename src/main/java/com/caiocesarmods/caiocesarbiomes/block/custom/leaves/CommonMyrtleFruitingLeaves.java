...
public class CommonMyrtleFruitingLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public CommonMyrtleFruitingLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if ("EARLY_SUMMER".equals(currentPhase) && nextStage != null && random.nextInt(2) == 0) {
        ...
        if ("MID_SUMMER".equals(currentPhase) && nextStage != null && random.nextInt(2) == 0) {
