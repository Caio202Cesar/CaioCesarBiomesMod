...
public class CooperBeechFallLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public CooperBeechFallLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
