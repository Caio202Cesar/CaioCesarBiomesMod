...
public class CooperBeechWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public CooperBeechWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
