...
public class FremontPoplarAutumnLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public FremontPoplarAutumnLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
