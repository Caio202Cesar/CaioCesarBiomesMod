...
public class FremontPoplarLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public FremontPoplarLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
