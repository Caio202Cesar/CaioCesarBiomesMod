...
public class FremontPoplarWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public FremontPoplarWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
