...
public class GinkgoWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public GinkgoWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
