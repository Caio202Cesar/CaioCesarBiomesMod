...
public class HawthornWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public HawthornWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
