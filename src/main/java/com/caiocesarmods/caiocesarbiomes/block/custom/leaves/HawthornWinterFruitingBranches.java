...
public class HawthornWinterFruitingBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public HawthornWinterFruitingBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if (temp >= 0.4F && "SPRING".equals(currentSeason) && nextStage != null && random.nextInt(25) == 0) {
        ...
        //Pattern for taiga biomes
        if (temp < 0.4F && "MID_SPRING".equals(phase) && nextStage != null && random.nextInt(25) == 0) {
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        if (!worldIn.isRemote) {
            ...
            worldIn.setBlockState(pos, TreeBlocks.HAWTHORN_WINTER_BRANCHES.get().getDefaultState());
