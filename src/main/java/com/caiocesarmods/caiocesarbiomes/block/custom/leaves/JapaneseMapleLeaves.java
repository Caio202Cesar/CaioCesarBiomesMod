...
public class JapaneseMapleLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public JapaneseMapleLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
