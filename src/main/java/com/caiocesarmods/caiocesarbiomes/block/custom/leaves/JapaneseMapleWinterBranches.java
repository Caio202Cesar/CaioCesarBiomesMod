...
public class JapaneseMapleWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public JapaneseMapleWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
