...
public class LaurelOakFallLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public LaurelOakFallLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
