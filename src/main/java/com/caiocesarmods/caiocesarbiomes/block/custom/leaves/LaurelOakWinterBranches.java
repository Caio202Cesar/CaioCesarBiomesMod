...
public class LaurelOakWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public LaurelOakWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
