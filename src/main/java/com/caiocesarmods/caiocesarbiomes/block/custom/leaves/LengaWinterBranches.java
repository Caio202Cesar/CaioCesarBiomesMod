...
public class LengaWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public LengaWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
