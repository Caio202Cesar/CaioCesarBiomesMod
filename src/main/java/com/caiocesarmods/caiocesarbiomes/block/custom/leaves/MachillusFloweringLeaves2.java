...
public class MachillusFloweringLeaves2 extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public MachillusFloweringLeaves2(Properties properties, Supplier<Block> nextStage) {
        super(properties);
