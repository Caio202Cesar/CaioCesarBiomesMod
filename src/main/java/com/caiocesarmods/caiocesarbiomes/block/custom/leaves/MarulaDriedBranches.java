...
public class MarulaDriedBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public MarulaDriedBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
