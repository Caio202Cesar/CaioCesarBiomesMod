...
public class MesquiteWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public MesquiteWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
