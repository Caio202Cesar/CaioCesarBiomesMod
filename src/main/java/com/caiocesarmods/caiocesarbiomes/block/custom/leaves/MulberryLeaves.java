...
public class MulberryLeaves extends LeavesBlock implements IForgeShearable {
    public MulberryLeaves(Properties properties) {
        super(properties);
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if ("SUMMER".equals(currentSeason) && random.nextInt(35) == 0) {
            ...
            worldIn.setBlockState(pos, TreeBlocks.MULBERRY_FRUITING_LEAVES.get()
