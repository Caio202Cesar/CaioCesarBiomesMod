...
public class MulberryWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public MulberryWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
