...
public class ObtusaOakFallLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public ObtusaOakFallLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if ("WINTER".equals(currentSeason) && nextStage != null && random.nextInt(65) == 0) {
