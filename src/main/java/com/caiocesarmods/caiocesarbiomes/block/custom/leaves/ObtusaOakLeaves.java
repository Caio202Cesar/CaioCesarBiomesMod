...
public class ObtusaOakLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public ObtusaOakLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if (temp <= 0.74F) {
            ...
            if ("FALL".equals(currentSeason) && nextStage != null && random.nextInt(55) == 0) {
