...
public class ObtusaOakWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public ObtusaOakWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
