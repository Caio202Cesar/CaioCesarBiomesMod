...
public class OleanderPinkLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public OleanderPinkLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
