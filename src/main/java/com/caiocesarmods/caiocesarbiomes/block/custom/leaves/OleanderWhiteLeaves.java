...
public class OleanderWhiteLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public OleanderWhiteLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
