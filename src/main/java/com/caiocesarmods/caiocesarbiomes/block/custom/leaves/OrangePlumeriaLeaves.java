...
public class OrangePlumeriaLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public OrangePlumeriaLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
