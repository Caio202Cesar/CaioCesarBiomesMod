...
public class OrchidTreeFloweringBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public OrchidTreeFloweringBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
