...
public class PeachWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public PeachWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
