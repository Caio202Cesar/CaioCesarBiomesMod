...
public class PersimmonFallLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public PersimmonFallLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
