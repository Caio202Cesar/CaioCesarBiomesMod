...
public class PersimmonLeaves extends LeavesBlock implements IForgeShearable {
    public PersimmonLeaves(Properties properties) {
        super(properties);
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if ("SUMMER".equals(currentSeason) && random.nextInt(55) == 0) {
            ...
            worldIn.setBlockState(pos, TreeBlocks.PERSIMMON_FLOWERING_LEAVES.get()
        ...
        if (temp <= 0.89F && temp >= 0.8F && "FALL".equals(currentSeason) && random.nextInt(45) == 0) {
            ...
            worldIn.setBlockState(pos, TreeBlocks.PERSIMMON_FALL_LEAVES.get()
                    .getDefaultState().with(LeavesBlock.DISTANCE, distance).with(LeavesBlock.PERSISTENT, persistent), 3);
        }
