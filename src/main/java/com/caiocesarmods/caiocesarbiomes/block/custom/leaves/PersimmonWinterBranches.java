...
public class PersimmonWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public PersimmonWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
