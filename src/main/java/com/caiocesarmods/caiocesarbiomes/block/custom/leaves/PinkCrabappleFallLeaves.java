...
public class PinkCrabappleFallLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public PinkCrabappleFallLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
