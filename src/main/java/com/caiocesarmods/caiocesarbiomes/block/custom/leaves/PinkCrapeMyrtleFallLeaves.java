...
public class PinkCrapeMyrtleFallLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public PinkCrapeMyrtleFallLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
