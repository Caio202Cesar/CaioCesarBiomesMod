...
public class PinkCrapeMyrtleLeaves extends LeavesBlock implements IForgeShearable {
    public PinkCrapeMyrtleLeaves(Properties properties) {
        super(properties);
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if (temp > 0.9F && "WINTER".equals(currentSeason) && random.nextInt(45) == 0) {
            ...
            worldIn.setBlockState(pos, TreeBlocks.PINK_CRAPE_MYRTLE_WINTER_BRANCHES.get()
