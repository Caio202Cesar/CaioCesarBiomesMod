...
public class PinkIvoryLeaves extends LeavesBlock implements IForgeShearable {
    public PinkIvoryLeaves(Properties properties) {
        super(properties);
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if (temp > 0.9F && "SUMMER".equals(currentSeason) && random.nextInt(45) == 0) {
            ...
            worldIn.setBlockState(pos, TreeBlocks.PINK_IVORY_DRIED_BRANCHES.get()
        ...
        if (temp > 0.9F && "SPRING".equals(currentSeason) && random.nextInt(5) == 0) {
            ...
            worldIn.setBlockState(pos, TreeBlocks.PINK_IVORY_FRUITING_LEAVES.get()
                    .getDefaultState().with(LeavesBlock.DISTANCE, distance).with(LeavesBlock.PERSISTENT, persistent), 3);
        }
        ...
        if (temp < 0.89F && "FALL".equals(currentSeason) && random.nextInt(45) == 0) {
            ...
            worldIn.setBlockState(pos, TreeBlocks.PINK_IVORY_FALL_LEAVES.get()
                    .getDefaultState().with(LeavesBlock.DISTANCE, distance).with(LeavesBlock.PERSISTENT, persistent), 3);
        }
