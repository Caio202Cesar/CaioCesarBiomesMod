...
public class PinkPlumeriaLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public PinkPlumeriaLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
