...
public class PistachioWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public PistachioWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
