...
public class PlaneWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public PlaneWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
