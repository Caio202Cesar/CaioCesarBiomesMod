...
public class PomegranateFruitingLeaves extends LeavesBlock implements IForgeShearable {
    public PomegranateFruitingLeaves(Properties properties) {
        super(properties);
    }
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if (temp >= 0.9F && "WINTER".equals(currentSeason) && random.nextInt(65) == 0) {
            ...
            worldIn.setBlockState(pos, TreeBlocks.POMEGRANATE_LEAVES.get()
                    .getDefaultState().with(LeavesBlock.DISTANCE, distance).with(LeavesBlock.PERSISTENT, persistent), 3);
        }
    }
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        if (!worldIn.isRemote) {
            ...
            worldIn.setBlockState(pos, TreeBlocks.POMEGRANATE_LEAVES.get().getDefaultState());
