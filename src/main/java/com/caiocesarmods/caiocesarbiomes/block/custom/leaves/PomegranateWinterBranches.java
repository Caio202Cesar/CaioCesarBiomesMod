...
public class PomegranateWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public PomegranateWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
