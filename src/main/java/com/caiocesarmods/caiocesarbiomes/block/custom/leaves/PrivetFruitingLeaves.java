...
public class PrivetFruitingLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public PrivetFruitingLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
