...
public class PurpleCrapeMyrtleFallLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public PurpleCrapeMyrtleFallLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
