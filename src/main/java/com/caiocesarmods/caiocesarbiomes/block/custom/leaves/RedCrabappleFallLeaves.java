...
public class RedCrabappleFallLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public RedCrabappleFallLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
