...
public class RedCrapeMyrtleFallLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public RedCrapeMyrtleFallLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
