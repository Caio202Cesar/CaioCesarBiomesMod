...
public class RedKapokFloweringBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public RedKapokFloweringBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
