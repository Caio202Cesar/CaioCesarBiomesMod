...
public class RedKapokFruitingLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public RedKapokFruitingLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if (temp >= 0.9F && "SUMMER".equals(currentSeason) && nextStage != null && random.nextInt(10) == 0) {
            ...
            ItemStack itemStack = new ItemStack(ModItems.MALABAR_SILK_FLOSS.get(), dropCount);
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        if (!worldIn.isRemote) {
            ...
            worldIn.setBlockState(pos, TreeBlocks.RED_KAPOK_LEAVES.get().getDefaultState());
