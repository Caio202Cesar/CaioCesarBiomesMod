...
public class RedKapokWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public RedKapokWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
