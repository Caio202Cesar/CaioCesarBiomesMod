...
public class RedMapleFallLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public RedMapleFallLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
