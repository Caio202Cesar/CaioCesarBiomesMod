...
public class RedMapleWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public RedMapleWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
