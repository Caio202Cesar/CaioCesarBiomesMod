...
public class RedOakWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public RedOakWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
