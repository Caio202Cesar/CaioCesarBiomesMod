...
public class RedPlumeriaDriedBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public RedPlumeriaDriedBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
