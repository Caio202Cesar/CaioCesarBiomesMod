...
public class RowanFallFruitingLeaves extends LeavesBlock implements IForgeShearable {
    public RowanFallFruitingLeaves(Properties properties) {
        super(properties);
    }
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if (temp < 0.89F && temp > 0.8F && "WINTER".equals(currentSeason) && random.nextInt(35) == 0) {
            ...
            worldIn.setBlockState(pos, TreeBlocks.ROWAN_WINTER_FRUITING_BRANCHES.get()
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        if (!worldIn.isRemote) {
            ...
            worldIn.setBlockState(pos, TreeBlocks.ROWAN_FALL_LEAVES.get().getDefaultState());
