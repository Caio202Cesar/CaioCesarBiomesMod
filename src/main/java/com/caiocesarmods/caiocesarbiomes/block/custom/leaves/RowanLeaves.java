...
public class RowanLeaves extends LeavesBlock implements IForgeShearable {
    public RowanLeaves(Properties properties) {
        super(properties);
    }
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if (temp <= 0.89F && temp >= 0.8F && "FALL".equals(currentSeason) && random.nextInt(45) == 0) {
            ...
            worldIn.setBlockState(pos, TreeBlocks.ROWAN_FALL_LEAVES.get()
        ...
        if ("SPRING".equals(currentSeason) && random.nextInt(10) == 0) {
            ...
            worldIn.setBlockState(pos, TreeBlocks.ROWAN_FLOWERING_LEAVES.get()
                    .getDefaultState().with(LeavesBlock.DISTANCE, distance).with(LeavesBlock.PERSISTENT, persistent), 3);
        }
