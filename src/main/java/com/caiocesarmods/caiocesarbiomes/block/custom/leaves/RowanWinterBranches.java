...
public class RowanWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public RowanWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
