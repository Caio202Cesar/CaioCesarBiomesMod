...
public class SouthernBeechFallLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public SouthernBeechFallLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
