...
public class SouthernBeechLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public SouthernBeechLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
