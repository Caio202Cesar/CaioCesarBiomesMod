...
public class SouthernBeechWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public SouthernBeechWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
