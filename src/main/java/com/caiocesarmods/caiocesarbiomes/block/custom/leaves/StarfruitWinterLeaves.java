...
public class StarfruitWinterLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public StarfruitWinterLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
