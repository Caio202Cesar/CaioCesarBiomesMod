...
public class TeakFruitingLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public TeakFruitingLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
