...
public class TropicalAlmondFallLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public TropicalAlmondFallLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if (temp >= 0.9F && "SUMMER".equals(currentSeason) && nextStage != null && random.nextInt(100) == 0) {
        ...
        if (temp >= 0.9F && "FALL".equals(currentSeason) && nextStage != null && random.nextInt(25) == 0) {
        ...
        if (temp <= 0.89F && "WINTER".equals(currentSeason) && nextStage != null && random.nextInt(45) == 0) {
