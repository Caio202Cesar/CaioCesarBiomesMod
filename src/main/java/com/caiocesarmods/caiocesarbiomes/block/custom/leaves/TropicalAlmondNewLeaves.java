...
public class TropicalAlmondNewLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public TropicalAlmondNewLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
