...
public class WeepingWillowBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public WeepingWillowBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
