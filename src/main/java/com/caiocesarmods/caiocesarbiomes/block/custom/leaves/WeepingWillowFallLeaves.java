...
public class WeepingWillowFallLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public WeepingWillowFallLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if (temp >= 0.8F && "WINTER".equals(currentSeason) && nextStage != null && random.nextInt(380) == 0) {
        ...
        if (temp <= 0.79F && "WINTER".equals(currentSeason) && nextStage != null && random.nextInt(150) == 0) {
