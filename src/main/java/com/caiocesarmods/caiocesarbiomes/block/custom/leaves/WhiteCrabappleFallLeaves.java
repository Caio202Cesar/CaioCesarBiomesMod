...
public class WhiteCrabappleFallLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public WhiteCrabappleFallLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
