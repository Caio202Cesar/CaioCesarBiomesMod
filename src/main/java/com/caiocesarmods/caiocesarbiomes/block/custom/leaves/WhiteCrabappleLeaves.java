...
public class WhiteCrabappleLeaves extends LeavesBlock implements IForgeShearable {
    public WhiteCrabappleLeaves(Properties properties) {
        super(properties);
    }
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if ("FALL".equals(currentSeason) && random.nextInt(25) == 0) {
            ...
            worldIn.setBlockState(pos, TreeBlocks.WHITE_CRABAPPLE_FALL_LEAVES.get()
                    .getDefaultState().with(LeavesBlock.DISTANCE, distance).with(LeavesBlock.PERSISTENT, persistent), 3);
            return;
