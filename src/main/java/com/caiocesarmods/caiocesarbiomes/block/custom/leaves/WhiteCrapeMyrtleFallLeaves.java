...
public class WhiteCrapeMyrtleFallLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public WhiteCrapeMyrtleFallLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
