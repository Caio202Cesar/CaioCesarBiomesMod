...
public class WhiteFigFallLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public WhiteFigFallLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
