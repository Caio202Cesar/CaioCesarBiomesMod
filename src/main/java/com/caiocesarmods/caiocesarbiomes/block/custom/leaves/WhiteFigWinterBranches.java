...
public class WhiteFigWinterBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public WhiteFigWinterBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
