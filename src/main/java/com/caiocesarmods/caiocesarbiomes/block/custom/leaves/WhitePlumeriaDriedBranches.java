...
public class WhitePlumeriaDriedBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public WhitePlumeriaDriedBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
