...
public class WhitePlumeriaLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public WhitePlumeriaLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
