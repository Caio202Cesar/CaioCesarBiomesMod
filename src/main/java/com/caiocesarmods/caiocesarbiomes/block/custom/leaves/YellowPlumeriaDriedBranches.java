...
public class YellowPlumeriaDriedBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public YellowPlumeriaDriedBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
