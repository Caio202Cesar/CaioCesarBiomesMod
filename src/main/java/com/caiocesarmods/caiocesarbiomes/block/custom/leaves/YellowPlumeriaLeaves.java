...
public class YellowPlumeriaLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public YellowPlumeriaLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
