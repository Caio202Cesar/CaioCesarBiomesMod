...
public class BunchberryFloweringPlant extends BushBlock {
    public BunchberryFloweringPlant() {
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if (random.nextDouble() < chance) {
            worldIn.setBlockState(pos, ModPlants.BUNCHBERRY_FRUITING_PLANT.get().getDefaultState());
