...
public class CalafateFloweringBush extends BushBlock {
    public CalafateFloweringBush() {
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if (random.nextDouble() < chance) {
            worldIn.setBlockState(pos, ModPlants.CALAFATE_FRUITING_BUSH.get().getDefaultState());
