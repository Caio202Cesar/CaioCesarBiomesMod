...
public class ChileanGuavaFloweringBush extends BushBlock {
    public ChileanGuavaFloweringBush() {
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if (random.nextDouble() < chance) {
            worldIn.setBlockState(pos, ModPlants.CHILEAN_GUAVA_FRUITING_BUSH.get().getDefaultState());
