...
public class InkberryBush extends BushBlock {
    public InkberryBush() {
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if (random.nextDouble() < chance) {
            worldIn.setBlockState(pos, ModPlants.INKBERRY_FRUITING_BUSH.get().getDefaultState());
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(ModPlants.INKBERRY_BUSH.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModPlants.INKBERRY_FRUITING_BUSH.get(), RenderType.getCutout());
