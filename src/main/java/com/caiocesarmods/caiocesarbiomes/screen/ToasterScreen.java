...
public class ToasterScreen extends ContainerScreen<ToasterContainer> {
    private final ResourceLocation GUI = new ResourceLocation(CaioCesarBiomesMod.MOD_ID,
            "textures/gui/toaster_gui.png");

    public ToasterScreen(ToasterContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
